            ...
            <div class="col-12">
                <div class="box_header common_table_header">
                    <div class="main-title d-md-flex">
                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('dashboard.dashboard_setup')); ?></h3>
                    </div>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="white_box_50px box_shadow_white">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('dashboard.make_widget_card_colorful')); ?></h3>
                        </div>
                    </div>
                    <div class="row">
                        <?php $__currentLoopData = app('dashboard_setup')->whereBetween('id', [1,12]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!isModuleActive('MultiVendor') && $config->id == 2): ?>
                            <?php else: ?>
                                <div class="col-4">
                                    ...
                                    <ul class="permission_list sms_list">
                                        <li>
                                            <label class="primary_checkbox d-flex mr-12 ">
                                                <input name="<?php echo e($config->type); ?>" class="config_type" type="radio" id="<?php echo e($config->type); ?>_1" value="0" <?php if($config->is_active == 0): ?> checked <?php endif; ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                            <p><?php echo e(__('dashboard.normal')); ?></p>
                                        </li>
                                        <li>
                                            <label class="primary_checkbox d-flex mr-12 ">
                                                <input name="<?php echo e($config->type); ?>" class="config_type" type="radio" id="<?php echo e($config->type); ?>_1" value="1" <?php if($config->is_active == 1): ?> checked <?php endif; ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                            <p><?php echo e(__('dashboard.color')); ?></p>
                                        </li>
                                        <li>
                                            <label class="primary_checkbox d-flex mr-12 ">
                                                <input name="<?php echo e($config->type); ?>" class="config_type" type="radio" id="<?php echo e($config->type); ?>_1" value="2" <?php if($config->is_active == 2): ?> checked <?php endif; ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                            <p><?php echo e(__('dashboard.reverse')); ?></p>
                                        </li>
                                    </ul>
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="box_header common_table_header mt-5">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('dashboard.make_visible_in_dashboard')); ?></h3>
                        </div>
                    </div>
                    <div class="row">
                        <?php $__currentLoopData = app('dashboard_setup')->whereBetween('id', [13,41]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $config_d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!isModuleActive('MultiVendor') && $config_d->id == 14 || $config_d->id == 27 || $config_d->id == 31): ?>
                        <?php else: ?>
                                <div class="col-4">
                                    <label class="primary_input_label">
                                        <?php
                                    ...
                                    <ul class="permission_list sms_list">
                                        <li>
                                            <label class="primary_checkbox d-flex mr-12 ">
                                                <input name="<?php echo e($config_d->type); ?>" class="config_type" type="radio" id="<?php echo e($config_d->type); ?>_1" value="1" <?php if($config_d->is_active == 1): ?> checked <?php endif; ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                            <p><?php echo e(__('dashboard.visible')); ?></p>
                                        </li>
                                        <li>
                                            <label class="primary_checkbox d-flex mr-12 ">
                                                <input name="<?php echo e($config_d->type); ?>" class="config_type" type="radio" id="<?php echo e($config_d->type); ?>_1" value="0" <?php if($config_d->is_active == 0): ?> checked <?php endif; ?>>
                                                <span class="checkmark"></span>
                                            </label>
                                            <p><?php echo e(__('dashboard.hide')); ?></p>
                                        </li>
                                    </ul>
                                </div>
                            <?php endif; ?>
    ...
    "use strict";
        $(document).ready(function(){
            $(document).on('change', '.config_type', function(){
                $.post("<?php echo e(route('appearance.dashoboard.status_update')); ?>", {_token:'<?php echo e(csrf_token()); ?>', type:this.name, is_active:this.value}, function(data){
                    if(data == 1){
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Production_dev/Modules/Appearance/Resources/views/dashboard/index.blade.php ENDPATH**/ ?>