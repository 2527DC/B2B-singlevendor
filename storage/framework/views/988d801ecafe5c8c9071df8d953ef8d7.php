                ...
                <div class="profile_white_box bg-white">
                    <ul class="nav profile_tabs mb_40" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="Info-tab" data-bs-toggle="tab" data-bs-target="#Info" type="button" role="tab" aria-controls="Info" aria-selected="true"><?php echo e(__('common.basic_info')); ?></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="Password-tab" data-bs-toggle="tab" data-bs-target="#Password" type="button" role="tab" aria-controls="Password" aria-selected="false"><?php echo e(__('common.change_password')); ?></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="Address-tab" data-bs-toggle="tab" data-bs-target="#Address" type="button" role="tab" aria-controls="Address" aria-selected="false"><?php echo e(__('common.address')); ?></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="language-tab" data-bs-toggle="tab" data-bs-target="#Language" type="button" role="tab" aria-controls="Language" aria-selected="false"><?php echo e(__('common.language')); ?></button>
                        </li>
                    </ul>
                            ...
                            <div class="dashboard_account_wrapper mb_20">
                                ...
                                <form action="#" name="basic_info" method="POST" id="basic_info" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb_30">
                                            <label class="primary_label2 style2 "><?php echo e(__('common.first_name')); ?> <span>*</span></label>
                                            <input name="first_name" id="first_name" placeholder="<?php echo e(__('common.first_name')); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.first_name')); ?>'" class="primary_input3 style4" type="text" value="<?php echo e($user_info->first_name); ?>">
                                            <span class="text-danger info_error" id="error_first_name"></span>
                                        </div>
                                        <div class="col-12 mb_30">
                                            <label class="primary_label2 style2 "><?php echo e(__('common.last_name')); ?></label>
                                            <input name="last_name" placeholder="<?php echo e(__('common.last_name')); ?>" id="last_name" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.last_name')); ?>'" class="primary_input3 style4" type="text" value="<?php echo e($user_info->last_name); ?>">
                                        </div>
                                        <div class="col-12 mb_30">
                                            <label class="primary_label2 style2 "><?php echo e(__('common.email_address')); ?></label>
                                            <input name="email" id="email" placeholder="<?php echo e(__('common.email_address')); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.email_address')); ?>'" class="primary_input3 style4" type="email" value="<?php echo e($user_info->email); ?>">
                                            <span class="text-danger info_error" id="error_email"></span>
                                        </div>
                                        <div class="col-12 mb_30">
                                            <label class="primary_label2 style2 "><?php echo e(__('common.phone_number')); ?></label>
                                            <input name="phone" id="phone" max="<?php echo e(app('general_setting')->max_digit); ?>" min="<?php echo e(app('general_setting')->min_digit); ?>" placeholder="01XX-XXX-XXX" onfocus="this.placeholder = ''" onblur="this.placeholder = '01XX-XXX-XXX'" class="primary_input3 style4" type="text" value="<?php echo e($user_info->phone); ?>">
                                            <span class="text-danger" id="error_phone"></span>
                                        </div>
                                        <div class="col-12 mb_30">
                                            <label class="primary_label2 style2 "><?php echo e(__('common.date_of_birth')); ?></label>
                                            <input id="start_datepicker" name="date_of_birth" placeholder="06/23/1995" onfocus="this.placeholder = ''" onblur="this.placeholder = '06/23/1995'" class="primary_input3 style4 mb-0" value="<?php echo e(date('m/d/Y',strtotime($user_info->date_of_birth))); ?>" type="text">
                                            <span class="text-danger" id="error_date_of_birth"></span>
                                        </div>
                                        <div class="col-12 mb_25">
                                            <label class="primary_label2 style2 "><?php echo e(__('common.description')); ?></label>
                                            <textarea id="textarea" name="name" placeholder="<?php echo e(__('common.description')); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.description')); ?>'" class="primary_textarea4 radius_5px"><?php echo e($user_info->description); ?></textarea>
                                        </div>
                                        <?php if(app('general_setting')->user_info_update == 1): ?>
                                            <div class="col-12 d-flex justify-content-end">
                                                <button type="button"  class="amaz_primary_btn style2 rounded-0  text-uppercase  text-center min_200" id="update_info"><?php echo e(__('common.update_now')); ?></button>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="account_img_upload">
                                    <div class="showingImageDiv">
                                        <div class="removeUpImage <?php echo e($user_info->avatar ? "" : "d-none"); ?>">
                                            <i class="fas fa-times"></i>
                                        </div>
                                        <div class="thumb mb_20">
                                        <img class="img-fluid" id="uploadImgShow" src="<?php echo e($user_info->avatar?showImage($user_info->avatar):showImage('frontend/default/img/avatar.jpg')); ?>" alt="<?php echo e(@$user_info->first_name); ?> <?php echo e(@$user_info->last_name); ?>" title="<?php echo e(@$user_info->first_name); ?> <?php echo e(@$user_info->last_name); ?>" id="avaterShow">
                                        </div>
                                    </div>
                                    <div class="primary_file_uploader d-flex align-items-center">
                                        <button type="button">
                                            <label class="primary-btn small fix-gr-bg" for="clickAndUpload"><?php echo e(__("common.browse")); ?> </label>
                                        ...
                                        <input class="primary-input border-0 p-0 ml-2" type="text" id="linkImageClickId" placeholder="<?php echo e(__('common.browse_image_file')); ?>" readonly="">
                                    </div>
                                    <label class="primary_input_label font_12" for="">(<?php echo e(getNumberTranslate(200)); ?> X
                                        <?php echo e(getNumberTranslate(200)); ?>)<?php echo e(__('common.px')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="tab-pane fade " id="Password" role="tabpanel" aria-labelledby="Password-tab">
                            ...
                            <form action="#" name="basic_info" method="POST" id="update_pass">
                                <div class="row">
                                    <div class="col-12 mb_30">
                                        <label class="primary_label"><?php echo e(__('common.current')); ?> <?php echo e(__('common.password')); ?></label>
                                        <input name="current_password" id="currentPassword" placeholder="<?php echo e(__('common.current')); ?> <?php echo e(__('common.password')); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.current')); ?> <?php echo e(__('common.password')); ?>'" class="primary_input3 style3" type="password">
                                        <span class="validation-old-pass-error text-danger error" ></span>
                                    </div>
                                    <div class="col-12 mb_30">
                                        <label class="primary_label"><?php echo e(__('common.new')); ?> <?php echo e(__('common.password')); ?></label>
                                        <input name="name" placeholder="<?php echo e(__('common.new')); ?> <?php echo e(__('common.password')); ?>" id="newPass" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.new')); ?> <?php echo e(__('common.password')); ?>'" class="primary_input3 style3" type="password">
                                        <span class="validation-new-pass-error text-danger error"></span>
                                    </div>
                                    <div class="col-12 mb_30">
                                        <label class="primary_label"><?php echo e(__('common.re_enter')); ?> <?php echo e(__('common.new')); ?> <?php echo e(__('common.password')); ?></label>
                                        <input name="new_password_confirmation" id="rePass" placeholder="<?php echo e(__('common.re_enter')); ?> <?php echo e(__('common.new')); ?> <?php echo e(__('common.password')); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = '<?php echo e(__('common.re_enter')); ?> <?php echo e(__('common.new')); ?> <?php echo e(__('common.password')); ?>'" class="primary_input3 style3" type="password">
                                        <span class="validation-new-pass-confirm-error text-danger error"></span>
                                    </div>
                                    <div class="col-12">
                                        <button class="amaz_primary_btn style2 rounded-0  text-uppercase  text-center min_200 change_password"><?php echo e(__('common.update_now')); ?></button>
                                    </div>
                                </div>
                            </form>
                            <!-- content ::end  -->
                        ...
                        <div class="tab-pane fade " id="Address" role="tabpanel" aria-labelledby="Address-tab">
                            ...
                            <div class="table-responsive mb_30">
                                <table class="table amazy_table style6 mb-0" id="address_table">
                                    <?php echo $__env->make('frontend.amazy.pages.profile.partials._table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </table>
                            </div>
                            <a href="#" class="add_new_address amaz_primary_btn style2 rounded-0 text-uppercase text-center min_200"><?php echo e(__('common.add_new_address')); ?></a>
                            <!-- content ::end  -->
                        </div>
                        <div class="tab-pane fade " id="Language" role="tabpanel" aria-labelledby="language-tab">
                            ...
                            ?>
                            <!-- content ::start  -->
                            <form action="<?php echo e(route('frontend.locale')); ?>" name="basic_info" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12 mb_30">
                                        <div class="form-group input_div_mb">
                                            <label class="primary_label2 style4"><?php echo e(__('defaultTheme.language')); ?> <span>*</span></label>
                                    ...
                                    <div class="col-12 mb_30">
                                        <div class="form-group input_div_mb">
                                            <label class="primary_label2 style4"><?php echo e(__('defaultTheme.currency')); ?> <span>*</span></label>
                                            <select class="theme_select style2 wide" name="currency" autocomplete="off">
                                                ...
                                                <option <?php echo e($currency_code==$item->code?'selected':''); ?>
                                                    ...
                                                    <?php echo e($item->name); ?> (<?php echo e($item->symbol); ?>)</option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <span class="text-danger" id="error_country"></span>
                                    ...
                                    <div class="col-12">
                                        <button class="amaz_primary_btn style2 rounded-0  text-uppercase  text-center min_200"><?php echo e(__('defaultTheme.save_change')); ?></button>
                                    </div>
                                </div>
                            </form>
                            <!-- content ::end  -->
    ...
    <?php echo $__env->make('frontend.amazy.partials._delete_modal_for_ajax',['item_name' => __('common.address'),'form_id' => 'adrs_delete_form','modal_id' => 'adrs_delete_modal'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
<?php echo $__env->make('frontend.amazy.pages.profile.partials._form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            $(document).ready(function(){
                ...
                $(document).on('click','.change_password', function(e){
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            toastr.success(response, "<?php echo e(__('common.success')); ?>");
                            $('#pre-loader').hide();
                ...
                $(document).on('submit', '#adrs_delete_form', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response == 'is_used'){
                                toastr.error("<?php echo e(__('customer_panel.address_already_used_for_shipping_or_billing_address')); ?>", "<?php echo e(__('common.error')); ?>");
                                $('#pre-loader').hide();
                            }
...
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Production_dev/resources/views/frontend/amazy/pages/profile/profile.blade.php ENDPATH**/ ?>