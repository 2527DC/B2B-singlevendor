        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                $(document).on('submit', '#item_delete_form', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.subscriber.delete')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                function changeStatus(el){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.subscriber.status')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on('click', '.send_verification_link', function(event){
                    ...
                    $('#pre-loader').removeClass('d-none');
                    $.post("<?php echo e(route('marketing.subscriber.send-verify-link')); ?>", data, function(response){
                        if(response.msg == 'success'){
                            toastr.success("<?php echo e(__('marketing.Verification link send successfully')); ?>","<?php echo e(__('common.success')); ?>");
                        }else{
                            toastr.error("<?php echo e(__('common.error_message')); ?>", "<?php echo e(__('common.error')); ?>");
                        }
                        $('#pre-loader').addClass('d-none');
                ...
                function subscriberDataTable(){
                    $('#subscriberTable').DataTable({
                        ...
                        stateSave: true,
                        "ajax": ( {
                            url: "<?php echo e(route('marketing.subscriber.get-data')); ?>"
                        }),
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/Marketing/Resources/views/subscribers/components/_scripts.blade.php ENDPATH**/ ?>