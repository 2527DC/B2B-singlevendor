...
<link rel="stylesheet" href="<?php echo e(asset(asset_path('modules/product/css/product_clone.css'))); ?>" />
            ...
            <form action="<?php echo e(route('product.store')); ?>" method="POST" enctype="multipart/form-data" id="choice_form">
                    ...
                    <div class="col-12">
                        <div class="box_header common_table_header">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.clone_product')); ?></h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                    ...
                                    <?php if(isModuleActive('FrontendMultiLang')): ?>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><strong><?php echo e(__('common.type')); ?></strong> <?php if($product->product_type == 2): ?> (<?php echo e(__('product.variant_product_is_not_changable_to_single_product')); ?>) <?php endif; ?><span
                                                        class="text-danger">*</span></label>
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" id="single_prod" value="1" <?php echo e($product->product_type == 2?'disabled':''); ?> <?php echo e($product->product_type == 1?'checked':''); ?>
                                                    ...
                                                    <li>
                                                        <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" value="2" id="variant_prod" <?php echo e($product->product_type == 2?'disabled':''); ?> <?php echo e($product->product_type == 2?'checked':''); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="product_name" id="product_name" placeholder="<?php echo e(__("common.name")); ?>" type="text" value="<?php echo e(old('product_name')?old('product_name'):$product->product_name); ?>" required="1">
                                    ...
                                    <?php endif; ?>
                                    <div class="col-lg-3 <?php echo e($product->product_type == 2 ? '' : 'd-none'); ?> variant_sku_prefix">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="variant_sku_prefix"> <?php echo e(__('product.variant_sku_prefix')); ?> <span class="text-danger">*</span></label>
                                            <input class="primary_input_field" name="variant_sku_prefix" id="variant_sku_prefix" placeholder="<?php echo e(__('product.variant_sku_prefix')); ?>" type="text" value="<?php echo e($product->variant_sku_prefix); ?>">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="model_number" placeholder="<?php echo e(__("common.model_number")); ?>" type="text" value="<?php echo e(old('model_number')?old('model_number'):$product->model_number); ?>">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for=""><?php echo e(__('product.barcode_type')); ?></label>
                                                <select name="barcode_type" id="barcode_type" class="primary_select mb-15">
                                                    <?php $__currentLoopData = barcodeList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $barcode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($barcode); ?>" <?php if($barcode == @$product->skus->first()->barcode_type): ?> selected <?php endif; ?>><?php echo e($barcode); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for=""> <?php echo e(__("product.minimum_order_qty")); ?> <span class="text-danger">*</span></label>
                                                <input class="primary_input_field" name="minimum_order_qty" id="minimum_order_qty" value="<?php echo e($product->minimum_order_qty); ?>" type="number" min="1" step="0" required="1">
                                                <span class="text-danger" id="error_minumum_qty"><?php echo e($errors->first('minimum_order_qty')); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for=""> <?php echo e(__("product.max_order_qty")); ?></label>
                                                <input class="primary_input_field" name="max_order_qty" type="number" min="0" step="0" value="<?php echo e($product->max_order_qty); ?>">
                                        ...
                                        <?php if(isModuleActive('GoogleMerchantCenter')): ?>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="gtin" id="gtin" placeholder="<?php echo e(__('common.gtin')); ?>" type="text" value="<?php echo e($product->gtin); ?>">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" name="mpn" id="mpn" placeholder="<?php echo e(__('common.mpn')); ?>" type="text" value="<?php echo e($product->mpn); ?>">
                                        ...
                                        <?php if(isModuleActive('ClubPoint')): ?>
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    <label class="primary_input_label" for="club_point"><?php echo e(__('clubpoint.point')); ?></label>
                                                    <input class="primary_input_field" name="club_point" id="club_point" placeholder="<?php echo e(__('clubpoint.point')); ?>" type="number" min="0" value="<?php echo e(@$product->club_point); ?>">
                                                    <span class="text-danger" id="error_discunt"><?php echo e($errors->first('club_point')); ?></span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12 attribute_div">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select name="choice_attributes[]" id="choice_attributes" class="primary_select mb-15">
                                                    <option value="" selected disabled><?php echo e(__('product.select_attribute')); ?></option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="customer_choice_options" id="customer_choice_options">
                                                <?php $__currentLoopData = $product->variations->unique("attribute_id"); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $choice_option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <input type="hidden" name="choice_no[]" id="attribute_id_<?php echo e($choice_option->attribute_id); ?>" value="<?php echo e($choice_option->attribute_id); ?>">
                                                            <div class="primary_input mb-25"><input class="primary_input_field" width="40%" name="choice[]" type="text" value="<?php echo e(\Modules\Product\Entities\Attribute::find($choice_option->attribute_id)->name); ?>" readonly></div>
                                                        </div>
                                                        <div class="col-lg-7">
                                                            <div class="primary_input mb-25">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 weight_height_div">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> <?php echo e(__('product.weight')); ?> [<?php echo e(__('product.gm')); ?>]</label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> <?php echo e(__('product.length')); ?> [<?php echo e(__('product.cm')); ?>]</label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> <?php echo e(__('product.breadth')); ?> [<?php echo e(__('product.cm')); ?>]</label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> <?php echo e(__('product.height')); ?> [<?php echo e(__('product.cm')); ?>]</label>
                                        ...
                                        <div class="col-lg-12 digital_file_upload_div_edit" style="display: <?php echo e(($product->is_physical == 1 || $product->product_type == 2)?'none':'block'); ?>;">
                                            ...
                                            ?>
                                            <label class="primary_input_label" for="pdf_place"><?php echo e(__('product.program_file_upload')); ?> <small> <?php if($digital_file): ?> <a class="link_color" href="<?php echo e(asset(asset_path(@$product->skus->first()->digital_file->file_source))); ?>" download><?php echo e(__('product.download_link')); ?></a> <?php endif; ?> </small> </label>
                                                <div class="primary_file_uploader">
                                                    <input class="primary-input" type="text" id="pdf_place" placeholder="<?php echo e(__('product.upload_file')); ?>"
                                                        readonly="">
                                        ...
                                        <?php if(!isModuleActive('MultiVendor')): ?>
                                            ...
                                            <div class="col-lg-12" id="stock_manage_div">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for="stock_manage"><?php echo e(__('product.stock_manage')); ?></label>
                                        ...
                                        <div class="col-lg-6 selling_price_div">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field selling_price" name="selling_price" id="selling_price" placeholder="<?php echo e(__("product.selling_price")); ?>" type="number" min="1" step="<?php echo e(step_decimal()); ?>" value="<?php echo e(@$product->skus->first()->selling_price); ?>" required>
                                                <span class="text-danger" id="error_selling_price"><?php echo e($errors->first('selling_price')); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for=""> <?php echo e(__("product.discount")); ?></label>
                                                <input class="primary_input_field" name="discount" id="discount" placeholder="<?php echo e(__("product.discount")); ?>" type="number" min="0" step="<?php echo e(step_decimal()); ?>" value="<?php echo e($product->discount); ?>">
                                                <span class="text-danger" id="error_discunt"><?php echo e($errors->first('discount')); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for=""><?php echo e(__('product.discount_type')); ?></label>
                                        ...
                                        <?php if(app('gst_config')['enable_gst'] == "only_tax"): ?> 
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="tax_id"><?php echo e(__('common.tax')); ?></label>
                                                <select class="primary_select mb-25" name="tax_id" id="tax_id">
                                                    ...
                                                    <?php $__currentLoopData = $gst_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($gst->id); ?>" <?php echo e($gst->id == $product->tax_id?'selected':''); ?>><?php echo e($gst->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <?php endif; ?>
                                        <!-- Whole-Sale -->
                                        <?php if(isModuleActive('WholeSale') && ($product->product_type==1)): ?>
                                            <div class="col-lg-12 whole_sale_info_add" id="whole_sale_info_add">
                                                <strong><?php echo e('Whole-Sale Price'); ?></strong>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <textarea class="summernote" name="description"><?php echo e($product->description); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="main-title d-flex">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <textarea class="summernote2" id="specification" name="specification"><?php echo e($product->specification); ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="meta_title" placeholder="<?php echo e(__("common.meta_title")); ?>" type="text" value="<?php echo e($product->meta_title); ?>">
                                                <span class="text-danger"><?php echo e($errors->first('meta_title')); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-4">
                                <div class="white_box pt-0 box_shadow_white p-15">
                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="true" data-type="image" data-name="images[]">
                                                    <input class="primary-input file_amount" type="text" id="thumbnail_image_file"
                                                        placeholder="<?php echo e(__('common.choose_images')); ?>" readonly="">
                                                    <button class="" type="button">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for=""><?php echo e(__('product.video_provider')); ?></label>
                                                <select class="primary_select mb-25" name="video_provider" id="video_provider">
                                                    <option value="youtube" <?php if($product->video_provider == "youtube"): ?> selected <?php endif; ?>><?php echo e(__('product.youtube')); ?></option>
                                                    <option value="daily_motion" <?php if($product->video_provider == "daily_motion"): ?> selected <?php endif; ?>><?php echo e(__('product.daily_motion')); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for=""> <?php echo e(__("product.video_link")); ?></label>
                                                <input class="primary_input_field" name="video_link" placeholder="<?php echo e(__("product.video_link")); ?>" type="text" value="<?php echo e($product->video_link); ?>">
                                        ...
                                        <?php if(isModuleActive('GoldPrice')): ?>
                                            <div class="col-lg-12">
                                                <div class="primary_input">
                                                    <label class="primary_input_label"><?php echo e(__('product.auto_update_required')); ?> <span class="text-danger">*</span></label>
                                                    <ul id="theme_nav" class="permission_list sms_list ">
                                                        <li>
                                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for="gold_price_id"><?php echo e(__('product.gold_price')); ?></label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="primary_input mb-15">
                                                    <label class="primary_input_label" for="making_charge"> <?php echo e(__('product.making_charge')); ?>
                                        ...
                                        <tbody id="tablecontentsupSaleAll">
                                            ...
                                            <?php $__currentLoopData = $upSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $upSale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="product_img_div">
                                                            <img class="product_list_img" src="<?php echo e(showImage($upSale->main_product->thumbnail_image_source)); ?>" alt="<?php echo e($upSale->main_product->product_name); ?>">
                                                        </div>
                                                    </td>
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <button class="primary_btn_2 mt-5 text-center saveBtn"><i class="ti-check"></i><?php echo e(__('common.save')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('product::products.clone_scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/DhatriProduction/Modules/Product/Resources/views/products/clone.blade.php ENDPATH**/ ?>