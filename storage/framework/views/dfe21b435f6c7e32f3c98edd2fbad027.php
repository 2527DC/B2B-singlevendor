<table class="table" id="requestProductTable">
    <thead>
    <tr>
        ...
        <th scope="col"><?php echo e(__('common.seller')); ?> <?php echo e(__('common.name')); ?></th>
...
<?php /**PATH /var/www/DhatriProduction/Modules/Product/Resources/views/products/request_product_list.blade.php ENDPATH**/ ?>