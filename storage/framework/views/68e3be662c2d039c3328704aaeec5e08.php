        ...
        $(document).ready(function(){
            ...
            function debounce(func, wait, immediate) {
                ...
                function getProductByChoice(type,el)
                {
                    ...
                    $('#pre-loader').show();
                    $.post(filterUrl, {_token:'<?php echo e(csrf_token()); ?>', filterType:filterType, requestItem:requestItem, requestItemType:requestItemType}, function(data){
                        $('#dataWithPaginate').html(data);
                        $('.filterCatCol').val(1);
                        $('#product_short_list').niceSelect();
                        $('#paginate_by').niceSelect();
...
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Production_dev/resources/views/frontend/amazy/pages/listing.blade.php ENDPATH**/ ?>