    ...
    <div class="modal-dialog modal_800px modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('shipping.update_carrier')); ?></h4>
            ...
            <div class="modal-body">
                <form id="update_form" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?php echo e($row->id); ?>" id="rowId">
                    <div class="row">
                        <?php if(isModuleActive('FrontendMultiLang')): ?>
                            <div class="col-lg-12">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade <?php if(auth()->user()->lang_code == $language->code): ?> show active <?php endif; ?>" id="element<?php echo e($language->code); ?>">
                                            <div class="col-lg-12">
                                                <div class="primary_input mb-15">
                                                    ...
                                                    <input class="primary_input_field" id="name_<?php echo e($language->code); ?>" name="name[<?php echo e($language->code); ?>]" placeholder="<?php echo e(__('common.name')); ?>" type="text" value="<?php echo e(isset($row)?$row->getTranslation('name',$language->code):old('name.'.$language->code)); ?>">
                        ...
                        <?php else: ?>
                            <div class="col-lg-12">
                                <div class="primary_input mb-15">
                                    ...
                                    <input class="primary_input_field" id="name" name="name" placeholder="<?php echo e(__('common.name')); ?>" type="text" value="<?php echo e($row->name); ?>">
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-15">
                                ...
                                <input class="primary_input_field" id="tracking_url" name="tracking_url" placeholder="<?php echo e(__('shipping.tracking_url')); ?>" type="text" value="<?php echo e($row->tracking_url); ?>">
                        ...
                        <div class="col-lg-4 mt-25">
                            <div class="flag_img_div">
                                <img id="logo_preview" src="<?php echo e($row->logo ? showImage($row->logo):showImage('flags/no_image.png')); ?>" alt="">
                            </div>
                        </div>
                        <div class="col-lg-12 text-center">
                            <div class="d-flex justify-content-center">
                                <button class="primary-btn semi_large2  fix-gr-bg mr-10"  type="submit"><i class="ti-check"></i><?php echo e(__('common.update')); ?></button>
...
<?php /**PATH /var/www/html/mytestdhatri/Modules/Shipping/Resources/views/carriers/edit.blade.php ENDPATH**/ ?>