                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.edit_brand')); ?></h3>
                        </div>
                    </div>
                </div>
            </div>
            <form action="<?php echo e(route("product.brand.update", $brand->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-lg-8">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade <?php if(auth()->user()->lang_code == $language->code): ?> show active <?php endif; ?>" id="element<?php echo e($language->code); ?>">
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <input class="primary_input_field" name="name[<?php echo e($language->code); ?>]" placeholder="<?php echo e(__("common.name")); ?>" type="text" value="<?php echo e(isset($brand)?$brand->getTranslation('name',$language->code):old('name.'.$language->code)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <textarea class="summernote" name="description[<?php echo e($language->code); ?>]"> <?php echo e(isset($brand)?$brand->getTranslation('description',$language->code):old('description.'.$language->code)); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php else: ?>
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label" for=""> <?php echo e(__("common.name")); ?> <span class="text-danger">*</span></label>
                                        <input class="primary_input_field" name="name" placeholder="<?php echo e(__("common.name")); ?>" type="text" value="<?php echo e($brand->name); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label" for=""> <?php echo e(__("common.description")); ?> </label>
                                        <textarea class="summernote" name="description"><?php echo e($brand->description); ?></textarea>
                                    </div>
                                </div>
                            <?php endif; ?>
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="tab-content">
                                        <?php $__currentLoopData = $LanguageList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div role="tabpanel" class="tab-pane pelement fade <?php if(auth()->user()->lang_code == $language->code): ?> show active <?php endif; ?>" id="pelement<?php echo e($language->code); ?>">
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        <label class="primary_input_label" for=""> <?php echo e(__("common.meta_title")); ?></label>
                                                        <input class="primary_input_field" name="meta_title[<?php echo e($language->code); ?>]" placeholder="<?php echo e(__("common.meta_title")); ?>" type="text" value="<?php echo e(isset($brand)?$brand->getTranslation('meta_title',$language->code):old('meta_title.'.$language->code)); ?>">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="primary_input mb-15">
                                                        ...
                                                        <textarea class="primary_textarea height_112 meta_description" placeholder="<?php echo e(__('common.meta_description')); ?>" name="meta_description[<?php echo e($language->code); ?>]" spellcheck="false"> <?php echo e(isset($brand)?$brand->getTranslation('meta_description',$language->code):old('meta_description.'.$language->code)); ?></textarea>
                            ...
                            <?php else: ?>
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label" for=""> <?php echo e(__("common.meta_title")); ?></label>
                                        <input class="primary_input_field" name="meta_title" placeholder="<?php echo e(__("common.meta_title")); ?>" type="text" value="<?php echo e($brand->meta_title); ?>">
                                        <span class="text-danger"><?php echo e($errors->first('meta_title')); ?></span>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label" for=""> <?php echo e(__("common.meta_description")); ?></label>
                                        <textarea class="primary_textarea height_112 meta_description" placeholder="<?php echo e(__('common.meta_description')); ?>" name="meta_description" spellcheck="false"><?php echo e($brand->meta_description); ?></textarea>
                                        <span class="text-danger"><?php echo e($errors->first('meta_description')); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                        ...
                                        <select class="primary_select mb-25" name="status" id="status">
                                            <option value="1" <?php if($brand->status == 1): ?> selected <?php endif; ?>><?php echo e(__('common.publish')); ?></option>
                                            <option value="0" <?php if($brand->status == 0): ?> selected <?php endif; ?>><?php echo e(__('common.pending')); ?></option>
                                        </select>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                        ...
                                        <div class="product_image_all_div">
                                            <?php if(@$brand->brand_image_media->media_id): ?>
                                                <input type="hidden" name="brand_image" class="product_images_hidden" value="<?php echo e(@$brand->brand_image_media->media_id); ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-30">
                                        <label class="switch_toggle" for="active_checkbox1">
                                            <input type="checkbox" id="active_checkbox1" name="featured" <?php if($brand->featured == 1): ?> checked <?php endif; ?>>
                                            <div class="slider round"></div>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button class="primary_btn_2"><i class="ti-check"></i><?php echo e(__("common.update")); ?> </button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Product/Resources/views/brand/edit.blade.php ENDPATH**/ ?>