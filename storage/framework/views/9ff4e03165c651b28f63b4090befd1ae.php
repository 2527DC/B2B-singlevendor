                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="permission_list sms_list">
                                    ...
                                    <li>
                                        <label class="primary_checkbox d-flex mr-12 ">
                                            <input name="enable_gst" type="radio" id="enable_gst_3" value="only_tax" <?php if(app('gst_config')['enable_gst'] == "only_tax"): ?> checked <?php endif; ?>>
                                            <span class="checkmark"></span>
                                        </label>
                                        <p><?php echo e(__('gst.is_active_only_tax')); ?></p>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-12 inside_state_div <?php if(app('gst_config')['enable_gst'] == "flat_tax" || app('gst_config')['enable_gst'] == "only_tax"): ?> d-none <?php endif; ?>">
                            ...
                            <div class="col-lg-12 outside_state_div <?php if(app('gst_config')['enable_gst'] == "flat_tax" || app('gst_config')['enable_gst'] == "only_tax"): ?> d-none <?php endif; ?>">
                                <div class="primary_input mb-15">
                            ...
                            <div class="col-lg-12 flat_div <?php if(app('gst_config')['enable_gst'] == "gst" || app('gst_config')['enable_gst'] == "only_tax"): ?> d-none <?php endif; ?>">
                                <div class="primary_input mb-15">
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/DhatriProduction/Modules/GST/Resources/views/configurations/index.blade.php ENDPATH**/ ?>