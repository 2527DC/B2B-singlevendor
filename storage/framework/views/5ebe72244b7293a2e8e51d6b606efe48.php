...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="primary_input mb-25">
            ...
            <input class="primary_input_field name" type="number" name="outsite_state_gst_percent[]" min="0" step="<?php echo e(step_decimal()); ?>" max="100" value="<?php echo e($gst->tax_percentage); ?>" autocomplete="off"  placeholder="">
        </div>
        <span class="text-danger" id="error_value"></span>
    </div>
</div>
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /var/www/DhatriProduction/Modules/GST/Resources/views/configurations/components/outsite_state_gst.blade.php ENDPATH**/ ?>