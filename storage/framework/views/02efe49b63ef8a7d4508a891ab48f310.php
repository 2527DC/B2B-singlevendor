    ...
    (function($){
        ...
        $(document).ready(function() {
            $(document).on('submit', '#add_form', function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('ticket.priority.store')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $(document).on('submit', '#edit_form', function(event) {
                ...
                formData.append('_token', "<?php echo e(csrf_token()); ?>");
                $.ajax({
                    url: "<?php echo e(route('ticket.priority.update')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $(document).on('submit', '#item_delete_form', function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('ticket.priority.delete')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $(document).on('change', '.status_change', function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('ticket.priority.status')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/SupportTicket/Resources/views/priority/components/scripts.blade.php ENDPATH**/ ?>