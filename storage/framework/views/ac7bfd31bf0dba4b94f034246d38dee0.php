...
$(document).ready(function(){
    ...
    $(document).on('input', '#title', function(){
        ...
        let value = $('#title<?php echo e(auth()->user()->lang_code); ?>').val();
        <?php else: ?>
        let value = $('#title').val();
        <?php endif; ?>
        let form = $('#form_for').val();
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Production_dev/Modules/FrontendCMS/Resources/views/widget_manage/index.blade.php ENDPATH**/ ?>