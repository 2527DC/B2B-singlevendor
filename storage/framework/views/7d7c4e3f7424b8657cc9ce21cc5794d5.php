...
<?php $__env->startSection('mainContent'); ?>
    <section class="admin-visitor-area up_st_admin_visitor">
        <?php echo $__env->make('setup::department.components.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('setup::department.components.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="box_header common_table_header">
                        ...
                        <h3 class="mb-3 mb-xl-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('hr.department')); ?> <?php echo e(__('common.list')); ?></h3>
                        <?php if(permissionCheck('departments.store')): ?>
                            <ul class="d-flex">
                                <li><button class="primary-btn radius_30px mr-10 fix-gr-bg" id="add_new_btn"><i class="ti-plus"></i><?php echo e(__('common.add_new')); ?></button></li>
                            </ul>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="QA_section QA_section_heading_custom check_box_table">
                        <div class="QA_table">
                            <div class="" id="item_table">
                                ...
                                <?php echo $__env->make('setup::department.components.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        (function($){
            ...
            $(document).ready(function() {
                ...
                $('#deleteItemModal').on('submit',function(event){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('departments.delete')); ?>",
                        type:"POST",
                        cache: false,
                        contentType: false,
                        processData: false,
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Setup/Resources/views/department/index.blade.php ENDPATH**/ ?>