        ...
        $(document).ready(function(){
            ...
            $(document).on('change','#coupon_type', function(event){
                ...
                $.get(url, function(data) {
                    ...
                    dynamicSelect2WithAjax("#product_list", "<?php echo e(url('/products/seller-products/get-by-ajax')); ?>", "GET");
            ...
            $(document).on('submit','#add_form', function(event){
                ...
                removeValidateError();
                if(coupon_type == null){
                    $('#error_coupon_type').text("<?php echo e(__('marketing.select_coupon_type_first')); ?>");
                }else{
                    $('#error_coupon_type').text('');
                    $("#submit_btn").prop('disabled', true);
                    $('#submit_btn').text('<?php echo e(__("common.submitting")); ?>');
                    $('#pre-loader').removeClass('d-none');
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.coupon.store')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
            ...
            $(document).on('submit','#edit_form', function(event){
                ...
                if(coupon_type == null){
                    ...
                    formData.append('_token', "<?php echo e(csrf_token()); ?>");
                    $.ajax({
                        url: "<?php echo e(route('marketing.coupon.update')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
            ...
            $(document).on('submit', '#item_delete_form', function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('marketing.coupon.delete')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            function couponDataTable(){
                $('#couponTable').DataTable({
                    ...
                    stateSave: true,
                    "ajax": ( {
                        url: "<?php echo e(route('marketing.coupon.get-data')); ?>"
                    }),
            ...
            function showValidationErrors(formType, errors) {
                ...
                <?php if(isModuleActive('FrontendMultiLang')): ?>
                    $(formType + ' #error_coupon_title_<?php echo e(auth()->user()->lang_code); ?>').text(errors['coupon_title.<?php echo e(auth()->user()->lang_code); ?>']);
                <?php else: ?>
            ...
            function removeValidateError(){
                ...
                $('#error_coupon_type').text('');
                <?php if(isModuleActive('FrontendMultiLang')): ?>
                $('#error_coupon_title_<?php echo e(auth()->user()->lang_code); ?>').text('');
                <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/Marketing/Resources/views/coupon/components/_scripts.blade.php ENDPATH**/ ?>