    ...
    <div class="modal-dialog large-modal modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('defaultTheme.add_invoice')); ?></h4>
...
<?php /**PATH /var/www/html/Production_dev/resources/views/backEnd/partials/_invoice_modal.blade.php ENDPATH**/ ?>