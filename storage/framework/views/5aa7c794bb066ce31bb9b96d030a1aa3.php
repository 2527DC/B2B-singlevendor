                ...
                <div class="col-xl-9 col-lg-8">
                    ...
                    <div class="white_box style2 bg-white mb_30">
                        <div class="dashboard_white_box_body dashboard_orderDetails_body">
                            <?php $__currentLoopData = $refund_request->refund_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $refund_detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="order_details_progress style2">
                                    ...
                                    <div class="single_order_progress position-relative d-flex align-items-center flex-column">
                                        <div class="icon position-relative ">
                                            <?php if($refund_detail->processing_state >= $process->id): ?>
                                ...
                                <div class="d-flex align-items-center gap_20 flex-wrap gray_color_1 dashboard_orderDetails_head  justify-content-between theme_border">
                                    <div class="d-flex flex-column  ">
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('common.order_id')); ?>: </h4> <p class="font_14 f_w_400 m-0 lh-base"><?php echo e(getNumberTranslate($refund_request->order->order_number)); ?></p>
                                        </div>
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('defaultTheme.order_date')); ?> :  </h4> <p class="font_14 f_w_400 m-0 lh-base"><?php echo e(getNumberTranslate($refund_request->order->created_at->format('d-m-Y h:i:s A'))); ?></p>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column ">
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('common.status')); ?>:   </h4> <p class="font_14 f_w_400 m-0 lh-base"> <?php echo e($refund_request->CheckConfirmed); ?></p>
                                        </div>
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('defaultTheme.request_sent_date')); ?>:   </h4> <p class="font_14 f_w_400 m-0 lh-base"> <?php echo e(getNumberTranslate($refund_request->created_at->format('d-m-Y h:i:s A'))); ?> </p>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column  ">
                                        <div class="d-flex align-items-center flex-wrap gap_5">
                                            <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('defaultTheme.order_amount')); ?>:   </h4> <p class="font_14 f_w_400 m-0 lh-base"> <?php echo e(single_price( $refund_request->total_return_amount)); ?></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table amazy_table3 style2 mb-0">
                                        <tbody>
                                            <?php $__currentLoopData = $refund_detail->refund_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $refund_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <a href="<?php echo e(singleProductURL(@$refund_product->seller_product_sku->product->seller->slug, @$refund_product->seller_product_sku->product->slug)); ?>" class="d-flex align-items-center gap_20 cart_thumb_div">
                                                            <div class="thumb">
                                                                <img src="
                                                            ...
                                                            <div class="summery_pro_content">
                                                                <h4 class="font_16 f_w_700 m-0 theme_hover"><?php echo e(textLimit(@$refund_product->seller_product_sku->product->product_name,30)); ?></h4>
                            ...
                            <div class="d-flex align-items-center gap_20 mb_20 flex-wrap gray_color_1 dashboard_orderDetails_head2  justify-content-between theme_border">
                                <div class="d-flex flex-column  ">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('defaultTheme.refund_method')); ?>:  </h4> <p class="font_14 f_w_400 m-0 lh-base"><?php echo e(strtoupper(str_replace("_"," ",$refund_request->refund_method))); ?></p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column ">
                                    <div class="d-flex align-items-center flex-wrap gap_5 mb_7">
                                    ...
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('defaultTheme.shipping_method')); ?>:   </h4> <p class="font_14 f_w_400 m-0 lh-base"> <?php echo e(strtoupper(str_replace("_"," ",$refund_request->shipping_method))); ?> </p>
                                    </div>
                                </div>
                                <div class="d-flex flex-column  ">
                                    <div class="d-flex align-items-center flex-wrap gap_5">
                                        <h4 class="font_14 f_w_500 m-0 lh-base"><?php echo e(__('defaultTheme.order_amount')); ?>:   </h4> <p class="font_14 f_w_400 m-0 lh-base"> <?php echo e(single_price( $refund_request->total_return_amount)); ?>65</p>
                                    </div>
                                </div>
                            </div>
                            <div class="order_details_list_box">
                                <div class="summery_order_body d-flex flex-wrap">
                                    <?php if($refund_request->shipping_method == "courier"): ?>
                                        <div class="summery_lists flex-fill">
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 ">
                                                    <h4 class="font_16 f_w_700 text-nowrap m-0 theme_hover"><?php echo e(__('defaultTheme.pick_up_info')); ?> </h4>
                                                </div>
                                            </div>
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0"><?php echo e(__('defaultTheme.shipping_gateway')); ?></h5><span>:</span>
                                                </div>
                                            ...
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                ...
                                                <p class="font_14 f_w_400 m-0"><?php echo e(getNumberTranslate(@$refund_request->pick_up_address_customer->phone)); ?></p>
                                            </div>
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                            ...
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0"><?php echo e(__('common.postcode')); ?></h5><span>:</span>
                                                </div>
                                                <p class="font_14 f_w_400 m-0"><?php echo e(getNumberTranslate(@$refund_request->pick_up_address_customer->postal_code)); ?></p>
                                            </div>
                                        </div>
                                    <?php else: ?>
                                        <div class="summery_lists flex-fill">
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 ">
                                                    <h4 class="font_16 f_w_700 text-nowrap m-0 theme_hover"><?php echo e(__('defaultTheme.drop_off_info')); ?> </h4>
                                                </div>
                                            </div>
                                            <div class="single_summery_list d-flex align-items-start gap_20">
                                                <div class="order_text_head d-flex align-items-center justify-content-between font_14 f_w_500 "><h5 class="font_14 f_w_500 m-0"><?php echo e(__('defaultTheme.shipping_gateway')); ?></h5><span>:</span>
                        ...
                        <div class="dashboard_white_box style3 rounded-0 bg-white mb_20">
                            <div class="dashboard_white_box_body">
                                ...
                                <p class="lineHeight1 font_14 f_w_400 mb-0">
                                    <?php echo e($process->description); ?>
...
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/resources/views/frontend/amazy/pages/profile/refunds/details.blade.php ENDPATH**/ ?>