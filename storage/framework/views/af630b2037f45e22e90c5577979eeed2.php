...
<script src="<?php echo e(asset(asset_path('backend/vendors/js/icon-picker.js'))); ?>">
</script>
    ...
    (function($){
        ...
        $(document).ready(function() {
            ...
            $(document).on('submit', '#socialLinkCreate', function(event) {
                ...
                $('#social_add_btn').text('<?php echo e(__('submitting')); ?>');
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.setting.social-link.store')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        $('#social_add_btn').text('<?php echo e(__('common.save')); ?>');
            ...
            $(document).on('submit', '#socialLinkEdit', function(event){
                ...
                $('#social_edit_btn').text('<?php echo e(__('common.updating')); ?>');
                let formElement = $(this).serializeArray()
                let formData = new FormData();
                formElement.forEach(element => {
                    formData.append(element.name, element.value);
                ...
                formData.append('_token', "<?php echo e(csrf_token()); ?>");
                $.ajax({
                url: "<?php echo e(route('admin.setting.social-link.update')); ?>",
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    ...
                    $('#social_edit_btn').text('<?php echo e(__('common.update')); ?>');
            ...
            $(document).on('submit','#item_delete_form', function(event) {
                ...
                $('#dataDeleteBtn').val('<?php echo e(__('common.deleting')); ?>');
                var formData = new FormData();
                formData.append('_token', "<?php echo e(csrf_token()); ?>");
                formData.append('id', $('#delete_item_id').val());
                let id = $('#delete_item_id').val();
                $.ajax({
                    url: "<?php echo e(route('admin.setting.social-link.delete')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        $('#dataDeleteBtn').val('<?php echo e(__('common.delete')); ?>');
                        location.reload();
                    },
                    error: function(response) {
                        $('#dataDeleteBtn').val('<?php echo e(__('common.delete')); ?>');
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/DhatriProduction/Modules/FrontendCMS/Resources/views/social_link/components/_scripts.blade.php ENDPATH**/ ?>