                        ...
                        <ul class="nav nav_list" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active show" href="#order_processing_data" role="tab"
                                    data-toggle="tab" id="product_list_id" aria-selected="true"><?php echo e(__('common.select_files')); ?></a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#order_complete_data" role="tab" data-toggle="tab" id="product_request_id"
                                    aria-selected="true"><?php echo e(__('common.uplaod_new')); ?></a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                                                ...
                                                <div class="primary_input ">
                                                    <ul id="theme_nav" class="permission_list sms_list ">
                                                        <li class="m-0">
                                                            ...
                                                            <p><?php echo e(__('common.selected_only')); ?></p>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="primary_input flex-fill d-flex justify-content-end">
                                                    <input class="primary_input_field max_340px" name="amaz_media_search" placeholder="<?php echo e(__('common.search')); ?>" type="text" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-footer p-0 border-0">
                <div class="controll_wrapper d-flex flex-wrap gap_20 w-100 media_list_controller">
                    <div class="select_and_reset_div d-flex align-items-center gap_20 flex-fill p-0">
                        <h4 class="upload_files_selected"> <?php echo e(__('common.0_file_selected')); ?></h4>
                    ...
                    <div class="next_prev_btn_div  d-flex align-items-center gap_10 p-0 flex-wrap">
                        <button type="button" class="primary_btn_2" id="uploader_prev_btn"><?php echo e(__('common.prev')); ?></button>
                        <button type="button" class="primary_btn_2" id="uploader_next_btn"><?php echo e(__('common.next')); ?></button>
                        <button type="button" class="primary_btn_2" data-toggle="amazUploaderAddSelected"><?php echo e(__('common.add_files')); ?></button>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /var/www/html/Production_dev/resources/views/backEnd/media_manager/media_modal.blade.php ENDPATH**/ ?>