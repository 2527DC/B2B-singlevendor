                ...
                <div class="col-lg-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('wallet.bank_recharge_transactions')); ?></h3>
                        </div>
                    </div>
        ...
        $(document).ready(function(){
            ...
            function walletTable(){
                $('#walletTable').DataTable({
                    ...
                    stateSave: true,
                    "ajax": ( {
                        url: "<?php echo e(route('bank_recharge.get-data')); ?>"
                    }),
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Wallet/Resources/views/backend/admin/bank_request_index.blade.php ENDPATH**/ ?>