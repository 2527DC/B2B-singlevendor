    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="primary_input mb-25">
                ...
                <input class="primary_input_field name" type="number" name="same_state_gst_percent[]" min="0" step="<?php echo e(step_decimal()); ?>" max="100" value="<?php echo e($exsist?$exsist:$gst->tax_percentage); ?>" autocomplete="off"  placeholder="">
            </div>
            <span class="text-danger" id="error_name"></span>
        </div>
    </div>
...
<?php else: ?>
    <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $amount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="primary_input mb-25">
                    <input class="primary_input_field name" type="number" name="same_state_gst_percent[]" min="0" step="<?php echo e(step_decimal()); ?>" max="100" value="<?php echo e($amount); ?>" autocomplete="off"  placeholder="">
                </div>
                <span class="text-danger" id="error_name"></span>
            </div>
        </div>
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?><?php /**PATH /var/www/DhatriProduction/Modules/GST/Resources/views/configurations/components/same_state_gst_edit.blade.php ENDPATH**/ ?>