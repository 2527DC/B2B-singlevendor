        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.add_color_variant_edit_row', function () {
                $('.variant_edit_row_lists:last').after(`<tr class="variant_edit_row_lists">
                        ...
                        <td class="pl-0 pb-0 border-0">
                            <input type='text' class='placeholder_input' placeholder='<?php echo e(__('product.color_name')); ?>' name="edit_variant_c_name[]" value='' />
                        </td>
                        <td class="pl-0 pb-0 pr-0 remove_edit border-0">
                            <div class="items_min_icon "><i class="ti-trash"></i></div>
                    </td></tr>`);
            ...
            function variantList() {
                $.ajax({
                    url: "<?php echo e(route("product.attribute.get_list")); ?>",
                    type: "GET",
                    dataType: "HTML",
                    success: function (response) {
            ...
            $(document).on('click', '.show_attribute', function(event){
                ...
                let id = $(this).data('id');
                $("#pre-loader").removeClass('d-none');
                $.post('<?php echo e(route('product.attribute.show')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:id}, function(data){
                    $('.show_div').html(data);
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/Product/Resources/views/attributes/scripts.blade.php ENDPATH**/ ?>