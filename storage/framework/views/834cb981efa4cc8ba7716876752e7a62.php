<div class="box_header common_table_header">
    <div class="main-title d-md-flex">
        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('setup.edit_tag')); ?></h3>
    </div>
</div>
...
<?php /**PATH /var/www/DhatriProduction/Modules/Setup/Resources/views/tags/edit.blade.php ENDPATH**/ ?>