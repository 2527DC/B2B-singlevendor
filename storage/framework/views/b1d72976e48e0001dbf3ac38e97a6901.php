                                ...
                                <?php endif; ?>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#drafted_products_data" role="tab" data-toggle="tab" id="drafted_products"
                                            aria-selected="true"><?php echo e(__('product.drafted_list')); ?></a>
                                    </li>
                                ...
                                <?php endif; ?>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#reported_product_data" role="tab" data-toggle="tab" id="reported_products"
                                            aria-selected="true"><?php echo e(__('product.reported_products')); ?></a>
                                    </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                            ...
                            <?php endif; ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="drafted_products_data">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.drafted_list')); ?></h3>
                                        </div>
                                    </div>
                                    <div class="QA_section QA_section_heading_custom check_box_table">
                                        <div class="QA_table">
                                            <!-- table-responsive -->
                                            <div class="" id="product_disabled_div">
                                                <?php echo $__env->make('product::products.drafted_products_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="reported_product_data">
                                <div class="box_header common_table_header ">
                                    <div class="main-title d-md-flex">
                                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.reported_products')); ?></h3>
                                    </div>
                                </div>
                                <div class="QA_section QA_section_heading_custom check_box_table">
                                    <div class="QA_table">
                                        ...
                                        <div class="" id="reported_product">
                                            <?php echo $__env->make('product::products.reported_product_table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form enctype="multipart/form-data" id="sku_edit_form">
                            <div class="row">
                                ...
                                <div class="col-lg-12 product_sku_img_div">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for=""><?php echo e(__('product.variant_image')); ?> <span class="text-danger">*</span></label>
                                        <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false" data-type="image" data-name="variant_image">
                                            <input class="primary-input file_amount" type="text" id="variant_img_file" placeholder="<?php echo e(__('product.variant_image')); ?>" readonly="">
...
<?php echo $__env->make('product::products.stock.manage_stock', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('product::products.stock.stock_history', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
    ...
    (function($){
        ...
        function draftedProductTable(){
            $('#drafted_product_table').DataTable({
                ...
                "stateSave": true,
                "ajax": ( {
                    url: "<?php echo e(route('product.get-data')); ?>"+'?table=drafted'
                }),
                "initComplete":function(json){
                },
                columns: columnData,
        ...
        function reportedProducts(){
            ...
            "stateSave": true,
            "ajax": ( {
                url: "<?php echo e(route('product.reportedProducts')); ?>"
            }),
            "initComplete":function(json){
            },
            columns: [
        ...
        function loadProductSkus(productId) {
            $('#pre-loader').removeClass('d-none');
            $.ajax({
                url: "<?php echo e(route('product.stock.get-skus')); ?>",
                type: "POST",
                data: {
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        toastr.error(response.error || "<?php echo e(__('common.error_message')); ?>");
                    }
                },
                error: function(response) {
                    $('#pre-loader').addClass('d-none');
        ...
        function updateSkuStock(skuId, stockType, quantity, note, isSkuModal = false) {
            $('#pre-loader').removeClass('d-none');
            $.ajax({
                url: "<?php echo e(route('product.stock.update')); ?>",
                type: "POST",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>",
                    sku_id: skuId,
                ...
                success: function(response) {
                    $('#pre-loader').addClass('d-none');
                    if (response.success) {
                        toastr.success(response.message || "<?php echo e(__('common.updated_successfully')); ?>");
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Production_dev/Modules/Product/Resources/views/products/index.blade.php ENDPATH**/ ?>