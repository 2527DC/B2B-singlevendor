        ...
        (function($){
            ...
            $(document).ready(function () {
                ...
                $(document).on('submit', '#createForm', function(event){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('shipping.pickup_locations.store')); ?>",
                        type:"POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on("click", ".view_row", function (event) {
                    ...
                    $('#pre-loader').removeClass('d-none');
                    let id = $(this).data("id");
                    let url =  "<?php echo e(route('shipping.pickup_locations.show',':id')); ?>";
                ...
                $(document).on("click", ".edit_row", function (event) {
                    ...
                    $('#pre-loader').removeClass('d-none');
                    let id = $(this).data("id");
                    let url =  "<?php echo e(route('shipping.pickup_locations.edit',':id')); ?>";
                    url = url.replace(':id',id);
                    $.get(url, function(data){
                ...
                $(document).on('submit', '#editForm', function(event){
                    ...
                    resetValidationError();
                    let id = $('#rowId').val();
                    let url =  "<?php echo e(route('shipping.pickup_locations.update',':id')); ?>";
                    url = url.replace(':id',id);
                    $.ajax({
                        url: url,
                        type:"POST",
                ...
                $(document).on('submit', '#pickup_location_delete_form', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('shipping.pickup_locations.destroy')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on('change', '.status_change', function(event){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('shipping.pickup_locations.status')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on('change', '.set_default', function(event){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('shipping.pickup_locations.set_default')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/Shipping/Resources/views/pickup_locations/components/_scripts.blade.php ENDPATH**/ ?>