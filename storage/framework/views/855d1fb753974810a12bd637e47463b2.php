                                                    ...
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="<?php echo e(__('common.date')); ?>"
                                                                ...
                                                                value="<?php echo e(dateConvert($user_info->date_of_birth)); ?>"
                                                                autocomplete="off">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""><?php echo e(__('common.avatar')); ?>
                                                ...
                                                (<?php echo e(getNumberTranslate(165)); ?>x<?php echo e(getNumberTranslate(165)); ?>) <?php echo e(__('common.px')); ?></label>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/resources/views/backEnd/pages/customer_data/profile.blade.php ENDPATH**/ ?>