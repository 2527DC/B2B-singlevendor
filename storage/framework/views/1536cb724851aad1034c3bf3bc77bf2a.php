    ...
    <div class="row">
        <div class="col-md-5 col-sm-6 col-xs-12">
            <div class="main-title mb-25 d-md-flex">
                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('general_settings.activation')); ?></h3>
                <?php if(isModuleActive('MultiVendor') && auth()->user()->role->type != 'seller'): ?>
                    <ul class="d-flex">
                        <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" href="<?php echo e(route("payment_gateway.setting")); ?>"><i class="fas fa-cog"></i><?php echo e(__('payment_gatways.global_configuration')); ?></a></li>
                    </ul>
                <?php endif; ?>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <?php if(config('app.sync')): ?>
                                                    <?php if(isModuleActive('Bkash') && $gateway_activation->method->method == 'Bkash'): ?>
                                                        <?php echo e(__('payment_gatways.bkash')); ?>

                                                        <span class="demo_addons"><?php echo e(__('common.addon')); ?></span>
                                                    <?php elseif(isModuleActive('SslCommerz') && $gateway_activation->method->method == 'SslCommerz'): ?>
                                                        <?php echo e(__('payment_gatways.ssl_commerz')); ?>

                                                        <span class="demo_addons"><?php echo e(__('common.addon')); ?></span>
                                                    <?php elseif(isModuleActive('MercadoPago') && $gateway_activation->method->method == 'Mercado Pago'): ?>
                                                        <?php echo e(__('payment_gatways.mercado_pago')); ?>

                                                        <span class="demo_addons"><?php echo e(__('common.addon')); ?></span>
                                                    <?php elseif(isModuleActive('Tabby') && $gateway_activation->method->method == 'Tabby'): ?>
                                                        <?php echo e(__('payment_gatways.tabby')); ?>

                                                        <span class="demo_addons"><?php echo e(__('common.addon')); ?></span>
                                                    <?php elseif(isModuleActive('CCAvenue') && $gateway_activation->method->method == 'CCAvenue'): ?>
                                                        <?php echo e(__('payment_gatways.ccavenue')); ?>

                                                        <span class="demo_addons"><?php echo e(__('common.addon')); ?></span>
                                                    <?php elseif(isModuleActive('Clickpay') && $gateway_activation->method->method == 'Clickpay'): ?>
                                        ...
                                        <td class="text-right">
                                            <label class="switch_toggle" for="checkbox<?php echo e($gateway_activation->id); ?>">
                                                <input type="checkbox" id="checkbox<?php echo e($gateway_activation->id); ?>" <?php if($gateway_activation->status == 1): ?> checked <?php endif; ?> <?php if(permissionCheck('update_payment_activation_status')): ?> value="<?php echo e($gateway_activation->id); ?>" class="payment_gateways_activate" <?php else: ?> disabled <?php endif; ?>>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/PaymentGateway/Resources/views/index.blade.php ENDPATH**/ ?>