...
<div class="row">
                                ...
                                <ul class="nav" role="tablist">
                                    <li class="nav-item mb-2">
                                        <a class="nav-link active show" href="#facebookTab" role="tab" data-toggle="tab"
                                            id="1" aria-selected="true"><?php echo e(__('auth.facebook')); ?></a>
                                    </li>
                                    <li class="nav-item mb-2">
                                        <a class="nav-link" href="#googleTab" role="tab" data-toggle="tab" id="1"
                                            aria-selected="true"><?php echo e(__('auth.google')); ?></a>
                                    </li>
                                    <li class="nav-item mb-2">
                                        <a class="nav-link" href="#twitterTab" role="tab" data-toggle="tab" id="1"
                                            aria-selected="true"><?php echo e(__('auth.twitter')); ?></a>
                                    </li>
                                    <li class="nav-item mb-2">
                                        <a class="nav-link" href="#linkedinTab" role="tab" data-toggle="tab" id="1"
                                            aria-selected="true"><?php echo e(__('auth.linkedin')); ?></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="white_box_30px mb_30">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active show" id="facebookTab">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('auth.facebook')); ?>

                                                <?php echo e(__('common.configuration')); ?></h3>
                                        </div>
                                    </div>
                                    <form action="<?php echo e(route('generalsetting.social_login_configuration.update')); ?>"
                                        method="POST" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for=""><?php echo e(__('auth.facebook')); ?>

                                                        <?php echo e(__('auth.client_id')); ?></label>
                                                    <input  name="facebook_client_id"
                                                        class="primary_input_field"
                                                        value="<?php echo e(env('FACEBOOK_CLIENT_ID')); ?>"
                                                        placeholder="<?php echo e(__('auth.facebook')); ?> <?php echo e(__('auth.client_id')); ?>"
                                                        type="text">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for=""><?php echo e(__('auth.facebook')); ?>
                                                        ...
                                                        <?php echo e(__('auth.client_secret')); ?></label>
                                                    <input  name="facebook_client_secret"
                                                        class="primary_input_field"
                                                        value="<?php echo e(env('FACEBOOK_CLIENT_SECRET')); ?>"
                                                        placeholder="<?php echo e(__('auth.facebook')); ?> <?php echo e(__('auth.client_secret')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <label class="switch_toggle" for="checkbox1">
                                                        <input name="facebook_status" type="checkbox" id="checkbox1"
                                                            value="1" <?php if(app('general_setting')->facebook_status == 1): ?>
                                                        checked <?php endif; ?>>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="alert alert-warning mt-30 text-center">
                                                    <?php echo e(__('payment_gatways.callback_url')); ?>: <?php echo e(url('/').'/login/facebook/callback'); ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade " id="googleTab">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('auth.google')); ?>
                                    ...
                                    <form action="<?php echo e(route('generalsetting.social_login_configuration.update')); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for=""><?php echo e(__('auth.google')); ?>

                                                        <?php echo e(__('auth.client_id')); ?></label>
                                                    <input  name="google_client_id" class="primary_input_field"
                                                        value="<?php echo e(env('GOOGLE_CLIENT_ID')); ?>"
                                                        placeholder="<?php echo e(__('auth.google')); ?> <?php echo e(__('auth.client_id')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <input  name="google_client_secret"
                                                        ...
                                                        placeholder="<?php echo e(__('auth.google')); ?> <?php echo e(__('auth.client_secret')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <label class="switch_toggle" for="checkbox2">
                                                        <input name="google_status" type="checkbox" class="checkbox" id="checkbox2"
                                                            value="1" <?php if(app('general_setting')->google_status == 1): ?>
                                                        checked <?php endif; ?>>
                                                        <div class="slider round"></div>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="alert alert-warning mt-30 text-center">
                                                    <?php echo e(__('payment_gatways.callback_url')); ?>: <?php echo e(url('/').'/login/google/callback'); ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade " id="twitterTab">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('auth.twitter')); ?>
                                    ...
                                    <form action="<?php echo e(route('generalsetting.social_login_configuration.update')); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for=""><?php echo e(__('auth.twitter')); ?>

                                                        <?php echo e(__('auth.client_id')); ?></label>
                                                    <input  name="twitter_client_id" class="primary_input_field"
                                                        value="<?php echo e(env('TWITTER_CLIENT_ID')); ?>"
                                                        placeholder="<?php echo e(__('auth.twitter')); ?> <?php echo e(__('auth.client_id')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <input  name="twitter_client_secret"
                                                        ...
                                                        placeholder="<?php echo e(__('auth.twitter')); ?> <?php echo e(__('auth.client_secret')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <label class="switch_toggle" for="checkbox3">
                                                        <input name="twitter_status" type="checkbox" id="checkbox3"
                                                            value="1" <?php if(app('general_setting')->twitter_status == 1): ?>
                                                        checked <?php endif; ?>>
                                                        <div class="slider round"></div>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="alert alert-warning mt-30 text-center">
                                                    <?php echo e(__('payment_gatways.callback_url')); ?>: <?php echo e(url('/').'/login/twitter/callback'); ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade " id="linkedinTab">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('auth.linkedin')); ?>
                                    ...
                                    <form action="<?php echo e(route('generalsetting.social_login_configuration.update')); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for=""><?php echo e(__('auth.linkedin')); ?>

                                                        <?php echo e(__('auth.client_id')); ?></label>
                                                    <input  name="linkedin_client_id"
                                                        class="primary_input_field"
                                                        value="<?php echo e(env('LINKEDIN_CLIENT_ID')); ?>"
                                                        placeholder="<?php echo e(__('auth.linkedin')); ?> <?php echo e(__('auth.client_id')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <input  name="linkedin_client_secret"
                                                        class="primary_input_field"
                                                        value="<?php echo e(env('LINKEDIN_CLIENT_SECRET')); ?>"
                                                        placeholder="<?php echo e(__('auth.linkedin')); ?> <?php echo e(__('auth.client_secret')); ?>"
                                                        type="text">
                                                    <span class="text-danger" id="edit_name_error"></span>
                                                </div>
                                            </div>
                                                ...
                                                <div class="primary_input mb-25">
                                                    ...
                                                    <label class="switch_toggle" for="checkbox4">
                                                        <input name="linkedin_status" type="checkbox" id="checkbox4"
                                                            value="1" <?php if(app('general_setting')->linkedin_status == 1): ?>
                                                        checked <?php endif; ?>>
                                                        <div class="slider round"></div>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="alert alert-warning mt-30 text-center">
                                                    <?php echo e(__('payment_gatways.callback_url')); ?>: <?php echo e(url('/').'/login/linkedin/callback'); ?>
    ...
    <div class="col-lg-5">
        <div class="white_box_30px mt-60">
            <div class="box_header common_table_header ">
                <div class="main-title d-md-flex">
                    <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('general_settings.facebook_messanger')); ?> <?php echo e(__('common.configuration')); ?></h3>
                </div>
            </div>
            <form action="<?php echo e(route('generalsetting.messangerChat.update')); ?>"
                method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            ...
                            <label class="switch_toggle" for="messanger_chat_status">
                                <input name="messanger_chat_status" type="checkbox" id="messanger_chat_status"
                                    value="1" <?php if($messanger_chat->status == 1): ?>checked <?php endif; ?>>
                                <div class="slider round"></div>
                            </label>
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="primary_input mb-25">
                            <label class="primary_input_label" for="code"><?php echo e(__('auth.facebook')); ?> <?php echo e(__('general_settings.messager_code')); ?></label>

                            <textarea name="code" id="code" cols="30" class="form-control primary_input_field overflow-auto" placeholder="<?php echo e(__('general_settings.paste_code_here')); ?>"
                                rows="10"><?php echo e($messanger_chat->code); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/DhatriProduction/Modules/GeneralSetting/Resources/views/social_login_configuration.blade.php ENDPATH**/ ?>