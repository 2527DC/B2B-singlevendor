        ...
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('submit', '#item_delete_form', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.news-letter.delete')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                function newsletterDataTable(){
                    $('#newsLetterTable').DataTable({
                        ...
                        stateSave: true,
                        "ajax": ( {
                            url: "<?php echo e(route('marketing.news-letter.get-data')); ?>"
                        }),
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Marketing/Resources/views/newsletter/components/_scripts.blade.php ENDPATH**/ ?>