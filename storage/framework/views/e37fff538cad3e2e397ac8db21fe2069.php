            ...
            <div class="col-lg-12">
                <div class="box_header common_table_header">
                    <div class="main-title d-md-flex">
                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"> <?php echo e(__('refund.pending_refund_requests')); ?></h3>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        (function($){
            ...
            $('#refundTable').DataTable({
                    ...
                    stateSave: true,
                    "ajax": ( {
                        url: "<?php echo e(route('refund.all_refund_request_data')); ?>"
                    }),
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Refund/Resources/views/admin/refund_requests/index.blade.php ENDPATH**/ ?>