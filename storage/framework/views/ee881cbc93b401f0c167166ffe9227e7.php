            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex">
                        <h3 class="mb-0 mr-30"><?php echo e(__('common.update')); ?> <?php echo e(__('common.customer')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="white_box_50px box_shadow_white">
                    <form action="<?php echo e(route('admin.customer.update', $customer->id)); ?>" method="POST" id="staff_addForm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="first_name" class="primary_input_field name"
                                        ...
                                        value="<?php echo e(old('first_name')?old('first_name'):$customer->first_name); ?>">
                            ...
                            <div class="col-xl-4">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="last_name" class="primary_input_field name"
                                        ...
                                        value="<?php echo e(old('last_name')?old('last_name'):$customer->last_name); ?>">
                            ...
                            <div class="col-xl-4">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="email" class="primary_input_field user_id name"
                                        placeholder="<?php echo e(__('common.email_or_phone')); ?>" type="text" value="<?php if(old('email')): ?> <?php echo e(old('email')); ?> <?php else: ?><?php echo e($customer->email?$customer->email:$customer->username); ?><?php endif; ?>">
                            ...
                            <div class="col-xl-4">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for=""><?php echo e(__('common.password')); ?>
                                        ...
                                        (<?php echo e(__('common.minimum_8_charecter')); ?>)</label>
                            ...
                            <div class="col-xl-4">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for=""><?php echo e(__('common.confirm_password')); ?></label>
                                    ...
                                    <ul id="theme_nav" class="permission_list sms_list ">
                                        <li>
                                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                                <input name="status" id="status_active" value="1" <?php echo e($customer->is_active == 1?'checked':''); ?> class="active"
                                                    type="radio">
                                        ...
                                        <li>
                                            <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                                <input name="status" value="0" id="status_inactive" class="de_active" type="radio" <?php echo e($customer->is_active == 0?'checked':''); ?>>
                                                <span class="checkmark"></span>
                                            </label>
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="d-flex justify-content-center pt_20">
                                    <button type="submit" class="primary-btn semi_large2 fix-gr-bg"
                                        id="save_button_parent"><i class="ti-check"></i><?php echo e(__('common.update')); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Customer/Resources/views/customers/edit.blade.php ENDPATH**/ ?>