                        ...
                        if(Object.keys(search_item).length > 0){
                            $('#search_history').html(`
                                <div class='search_product_info search_history'>
                                    <p>search history</p>
                                    <strong id='clear_search'><?php echo e(__('common.clear')); ?></strong>
                                    </div>
                    ...
                    if(localStorage.getItem('search_history') != null && localStorage.getItem('search_history') != undefined){
                        ...
                        if(Object.keys(search_item).length > 0){
                            $('#search_history2').html(`
                                <div class='search_product_info search_history'>
                                    <p>search history</p>
                                    <strong id='clear_search2'><?php echo e(__('common.clear')); ?></strong>
                                    </div>
            ...
            function doneTyping () {
                ...
                .done(function (response) {
                    ...
                    if(response.tags.length > 0){
                        $("#tag_search").html(`
                            <div class="tag_box">
                                    <a href="javascript:void(0)" class="search_title "><?php echo e(__('common.popular_suggestions')); ?></a>
                            </div>
                    ...
                    if(response.categories.length > 0){
                        $('#category_search').html(`
                            <div class="tag_box">
                                <a href="javascript:void(0)" class="search_title"><?php echo e(__('common.category_suggestions')); ?></a>
                            </div>
                    ...
                    if(response.products.length > 0){
                        $('#product_search').html(`
                            <div class="tag_box">
                                    <a href="javascript:void(0)" class="search_title"><?php echo e(__('common.products')); ?></a>
                            </div>
                        ...
                        response.products.forEach((item) => {
                            ...
                            if(item.stock){
                                stock = `<div class="product_available"><?php echo e(__('product.in_stock')); ?></div>`;
                            }else{
                                stock = `<div class="product_stockout"><?php echo e(__('prodcut.stock_out')); ?></div>`;
                            }
                            productData += `
                                    ...
                                    <div class="product_info d-flex align-items-center flex-fill gap_10">
                                        <div class="thumb">
                                            <?php if(app('general_setting')->lazyload == 1): ?>
                                                <img data-src="${item.thumb_img}" alt="${item.product_name}" title="${item.product_name}" src="<?php echo e(showImage(themeDefaultImg())); ?>" class="lazyload">
                                            <?php else: ?>
                    ...
                    if(response.sellers != undefined){
                        if(response.sellers.length > 0){
                            $('#seller_search').html(`
                                <div class="tag_box">
                                    <a href="#" class="search_title"><?php echo e(__('common.shops')); ?></a>
                                </div>
                                ...
                                sellerData += `
                                    <a href="${url}" data-type="product" class="store_link product_search_single d-flex align-items-center gap_10">
                                        <div class="product_info flex-fill d-flex gap_10 mb_10 align-items-center">
                                            <div class="thumb">
                                                <img data-src="${item.avater}" alt="${item.first_name}" title="${item.first_name}" src="<?php echo e(showImage(themeDefaultImg())); ?>" class=lazyload>
                                            </div>
                                            <div class="product_info_text">
                    ...
                    if(response.tags.length < 1 && response.products.length < 1 && response.categories.length < 1){
                        ...
                        $('#search_empty_list').html(`
                            <div class="search_empty_list_div">
                                <p><?php echo e(__('common.nothing_found_for')); ?> "<strong class="search_keyword">${keyword}</strong>"</p>
                            </div>
                        `);
                    }
...
<?php echo $__env->make('frontend.amazy.partials.global_script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /var/www/html/Production_Test/resources/views/frontend/amazy/partials/_script.blade.php ENDPATH**/ ?>