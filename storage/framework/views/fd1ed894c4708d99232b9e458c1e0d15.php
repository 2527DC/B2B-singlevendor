<form id="formData" method="POST" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="primary_input mb-25">
                <label class="mb-2 mr-30"><?php echo e(__('common.image')); ?><small>(<?php echo e(getNumberTranslate(1410)); ?>x<?php echo e(getNumberTranslate(191)); ?>) <?php echo e(__('common.px')); ?></small></label>
                ...
                <div class="w-100 mt-3">
                    <a  class="remove-image primary-btn ml-2 fix-gr-bg <?php echo e(empty($promotionbar) || empty($promotionbar->image) ? 'd-none':''); ?>" data-default-img='<?php echo e(asset("public/backend/img/default.png")); ?>' data-id='<?php echo e($promotionbar->id); ?>' href="<?php echo e(route('frontendcms.promotionbar.removeImage')); ?>">Remove Image</a>
                </div>
            </div>
        </div>
...
<?php /**PATH /var/www/html/Production_dev/Modules/FrontendCMS/Resources/views/promotion_bar/components/form.blade.php ENDPATH**/ ?>