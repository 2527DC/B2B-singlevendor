        ...
        (function($){
            ...
            $(document).ready(function () {
                ...
                <?php endif; ?>
                    ...
                    $.ajax({
                        url: "<?php echo e(route('refund.process_store')); ?>",
                        data: formData,
                ...
                $(document).on("submit", "#processEditForm", function (event) {
                    ...
                    let formData = $(this).serializeArray();
                    $.ajax({
                        url: baseUrl + "/refund/refund-peocess-update/" + id,
                        data: formData,
                        headers: {'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')},
                        type: "POST",
                        dataType: "JSON",
                ...
                function refund_process_list() {
                    $('#pre-loader').removeClass('d-none');
                    $.ajax({
                        url: "<?php echo e(route("refund.process_list")); ?>",
                        type: "GET",
                        dataType: "HTML",
                        success: function (response) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/Refund/Resources/views/admin/refund_process/scripts.blade.php ENDPATH**/ ?>