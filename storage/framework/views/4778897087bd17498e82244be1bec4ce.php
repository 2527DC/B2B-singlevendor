                            ...
                            if (max_qty != '' && min_qty != '') {
                                if(parseInt(value)>=1){
                                    if(parseInt(value) > parseInt(max_qty) && parseInt(value) > parseInt(min_qty)){
                                        toastr.warning('<?php echo e(__("defaultTheme.maximum_quantity_limit_exceed")); ?>'+max_qty+'.', '<?php echo e(__("common.warning")); ?>');
                                    }else if(parseInt(value) < parseInt(max_qty) && parseInt(value) < parseInt(min_qty)){
                                        toastr.warning('<?php echo e(__("defaultTheme.minimum_quantity_limit_exceed")); ?>'+min_qty+'.', '<?php echo e(__("common.warning")); ?>');
                                    }else{
                                ...
                                if(parseInt(value)>=1){
                                    ...
                                    if (parseInt(value) == 0) {
                                        toastr.warning('<?php echo e(__("defaultTheme.maximum_quantity_limit_exceed")); ?>'+min_qty+'.', '<?php echo e(__("common.warning")); ?>');
                                    }
                                    return false;
                                }
                            }else{
                ...
                <?php if(!empty($public_code)): ?>
                    if($("#grand_total").length > 0){
                        ...
                        new TabbyPromo({
                            ...
                            merchantCode: '<?php echo e($merchantCode); ?>'  // required
                        });
                    }
                <?php endif; ?>
...
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Production_dev/resources/views/frontend/amazy/pages/cart.blade.php ENDPATH**/ ?>