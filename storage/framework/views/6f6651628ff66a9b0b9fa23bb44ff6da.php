    ...
    (function($) {
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.wholesale_p_save_btn', function (){
                ...
                for (var w=0; w<wholesale_min_qty_v.length; w++){
                    w_s_p_list[w] = "<li><?php echo e(__('wholesale.Range')); ?>:("+wholesale_min_qty_v[w]+"-"+wholesale_max_qty_v[w]+")     $"+wholesale_price_v[w]+"</li>";
                }
        ...
        $(document).on('click','.saveBtn',function() {
            ...
            if ($('input[name=product_type]:checked').val() === '1' && $("#selling_price").val() === '') {
                ...
                requireMatch = 1;
                $('#error_selling_price').text("<?php echo e(__('product.please_input_selling_price_minimum_one')); ?>");
            }
            if ($("#tax").val() === '') {
                requireMatch = 1;
            ...
            if ($('input[name=product_type]:checked').val() === '2') {
                if ($('#variant_sku_prefix').val()== '') {
                    requireMatch = 1;
                    $('#error_variant_sku_prefix').text("<?php echo e(__('product.please_input_variant_sku_prefix')); ?>");
                }
            }
            if ($('input[name=product_type]:checked').val() === '2') {
                $('input[name*=selling_price_sku]').each(function() {
                    if ($(this).val()== '') {
                        requireMatch = 1;
                        toastr.warning("<?php echo e(__('product.please_input_selling_price')); ?>");
                    }else if ($(this).val()== 0) {
                        requireMatch = 1;
                        toastr.warning("<?php echo e(__('product.please_input_selling_price_minimum_one')); ?>");
                    }
                });
            }
            if (requireMatch == 1) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/Production_dev/Modules/Product/Resources/views/products/edit_scripts.blade.php ENDPATH**/ ?>