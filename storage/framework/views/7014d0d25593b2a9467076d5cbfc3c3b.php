    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('payment_gatways.bank_payment')); ?></h5>
                <button type="button" class="close " data-bs-dismiss="modal">
                    <i class="ti-close "></i>
                </button>
            </div>
            <form name="bank_payment" enctype="multipart/form-data" action="<?php echo e(route('my-wallet.store')); ?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6 mb_20">
                            <label for="name" class="mb-2"><?php echo e(__('payment_gatways.bank_name')); ?>

                                <span class="text-danger">*</span></label>
                            <input type="text" class="primary_input4 form-control" placeholder="<?php echo e(__('payment_gatways.bank_name')); ?>"
                                name="bank_name" value="<?php echo e(@old('bank_name')); ?>">
                            <span class="text-danger" id="bank_name"></span>
                        </div>
                        <div class="col-xl-6 col-md-6 mb_20">
                            <label for="name" class="mb-2"><?php echo e(__('payment_gatways.branch_name')); ?>

                                <span class="text-danger">*</span></label>
                            <input type="text" name="branch_name" class="primary_input4 form-control"
                                placeholder="<?php echo e(__('payment_gatways.branch_name')); ?>" value="<?php echo e(@old('branch_name')); ?>">
                            <span class="text-danger" id="branch_name"></span>
                        </div>
                    </div>
                    <div class="row mb-20">
                        <div class="col-xl-6 col-md-6 mb_20">
                            <label for="name" class="mb-2"><?php echo e(__('payment_gatways.account_number')); ?>

                                <span class="text-danger">*</span></label>
                            <input type="text" class="primary_input4 form-control" placeholder="<?php echo e(__('payment_gatways.account_number')); ?>"
                                name="account_number" value="<?php echo e(@old('account_number')); ?>">
                            <span class="text-danger" id="account_number"></span>
                        </div>
                        <div class="col-xl-6 col-md-6 mb_20">
                            <label for="name" class="mb-2"><?php echo e(__('payment_gatways.account_holder')); ?>

                                <span class="text-danger">*</span></label>
                            <input type="text" name="account_holder" class="primary_input4 form-control"
                                placeholder="<?php echo e(__('payment_gatways.account_holder')); ?>" value="<?php echo e(@old('account_holder')); ?>">
                            <span class="text-danger" id="account_holder"></span>
                        </div>
                        <input type="hidden" name="deposit_amount" value="<?php echo e($recharge_amount); ?>">
                    ...
                    <div class="row  mb-20">
                        ...
                        <div class="col-xl-12 col-md-12 mb_20">
                            <label for="name" class="mb-2"><?php echo e(__('wallet.cheque_slip')); ?></label>
                    ...
                    <fieldset class="mt-3">
                        <legend><?php echo e(__('payment_gatways.bank_account_info')); ?>
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <button class="amaz_primary_btn style3 text-nowrap" type="submit" id="bankpayment_submit_btn"
                        disabled><?php echo e(__('common.payment')); ?></button>
                </div>
            </form>
        </div>
    </div>
</div>
<?php /**PATH /var/www/html/mytestdhatri/resources/views/frontend/amazy/pages/profile/wallets/components/_bank_payment_modal.blade.php ENDPATH**/ ?>