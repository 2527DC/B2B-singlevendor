        ...
        (function($){
            ...
            $(document).ready(function () {
                ...
                <?php endif; ?>
                    ...
                    $.ajax({
                        url: "<?php echo e(route('order_manage.process_store')); ?>",
                        data: formData,
                ...
                $(document).on("submit", "#processEditForm", function (event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('admin.delivery-process.update')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                function refund_process_list() {
                    $('#pre-loader').removeClass('d-none');
                    $.ajax({
                        url: "<?php echo e(route("order_manage.process_list")); ?>",
                        type: "GET",
                        dataType: "HTML",
                        success: function (response) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/OrderManage/Resources/views/delivery_process/scripts.blade.php ENDPATH**/ ?>