    ...
    <script>
        ...
        */
        function getGooglePaymentsConfiguration() {
            return {
                environment: '<?php echo e(@$credential->perameter_1); ?>',
                apiVersion: 2,
                apiVersionMinor: 0,
                merchantInfo: {
                      // A merchant ID is available after approval by Google.
                      // 'merchantId':'12345678901234567890',
                      merchantName: '<?php echo e(@$credential->perameter_4); ?>'
                },
                allowedPaymentMethods: [{
                  ...
                  tokenizationSpecification: {
                    ...
                    parameters: {
                      'gateway': '<?php echo e(@$credential->perameter_2); ?>',
                      'gatewayMerchantId': '<?php echo e(@$credential->perameter_3); ?>'
                    }
                  }
                }]
            };
        ...
        */
        function createPaymentRequest() {
            ...
            const details = {
                total: {label: 'Wallet Recharge', amount: {currency: '<?php echo e(app('general_setting')->currency_code); ?>', value: '<?php echo e($recharge_amount); ?>'}}
            };
        ...
        */
        ...
        {
            $.post('<?php echo e(route("googlePay.payment_status")); ?>', {_token:'<?php echo e(csrf_token()); ?>', purpose:'wallet_recharge', amount:'<?php echo e($recharge_amount); ?>', requestId:el}, function(data){
               if(data == 1){
                   toastr.success("<?php echo e(__('common.transaction_successfully')); ?>","<?php echo e(__('common.success')); ?>")
                   location.replace("<?php echo e(route('my-wallet.index', auth()->user()->role->type)); ?>");
               }
               else{
                   toastr.error("<?php echo e(__('common.transaction_failed')); ?>","<?php echo e(__('common.error')); ?>");
               }
           });
        }
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/resources/views/frontend/amazy/pages/profile/wallets/components/_google_pay_script.blade.php ENDPATH**/ ?>