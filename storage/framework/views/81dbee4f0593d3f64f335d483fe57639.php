        ...
        <div class="white-box">
            <form action="" id="add_form">
                <div class="add-visitor">
                    ...
                    <div class="row mt-40">
                        <?php if(permissionCheck('ticket.category.store')): ?>
...
<?php /**PATH /var/www/html/mytestdhatri/Modules/SupportTicket/Resources/views/category/components/create.blade.php ENDPATH**/ ?>