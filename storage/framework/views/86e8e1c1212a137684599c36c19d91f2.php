                            ...
                            <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field" name="product_name[<?php echo e($language->code); ?>]" id="product_name_<?php echo e($language->code); ?>" placeholder="<?php echo e(__('common.name')); ?>" type="text" value="<?php echo e(old('product_name.'.$language->code)); ?>">
                                                            ...
                                                            <div class="col-lg-6 sku_single_div d-none" id="default_lang_<?php echo e($language->code); ?>">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field" name="product_sku[<?php echo e($language->code); ?>]" id="sku_single" placeholder="<?php echo e(__('product.product_sku')); ?>" type="text" value="<?php echo e(old('product_sku.'.$language->code)); ?>">
                                                            ...
                                                            <div class="col-lg-6 <?php if(!app('general_setting')->product_subtitle_show): ?> d-none <?php endif; ?>">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field" name="subtitle_1[<?php echo e($language->code); ?>]" id="subtitle_1" placeholder="<?php echo e(__('product.subtitle_1')); ?>" type="text" value="<?php echo e(old('subtitle_1.'.$language->code)); ?>">
                                                            ...
                                                            <div class="col-lg-6 <?php if(!app('general_setting')->product_subtitle_show): ?> d-none <?php endif; ?>">
                                                                <div class="primary_input mb-15">
                                                                    ...
                                                                    <input class="primary_input_field" name="subtitle_2[<?php echo e($language->code); ?>]" id="subtitle_2" placeholder="<?php echo e(__('product.subtitle_2')); ?>" type="text" value="<?php echo e(old('subtitle_2.'.$language->code)); ?>">
                                    ...
                                    <div class="col-lg-6 sku_single_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="sku_single"> <?php echo e(__('product.product_sku')); ?>  <span class="text-danger">*</span> </label>
                                    ...
                                    <div class="col-lg-3 d-none variant_sku_prefix">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="variant_sku_prefix" id="variant_sku_prefix" placeholder="<?php echo e(__('product.variant_sku_prefix')); ?>" type="text" value="<?php echo e(old('variant_sku_prefix')); ?>">
                                    ...
                                    <?php if(isModuleActive('ClubPoint')): ?>
                                        ...
                                        <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="club_point" id="club_point" placeholder="<?php echo e(__('clubpoint.point')); ?>" type="number" min="0" value="<?php echo e(old('club_point')?old('club_point'):0); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <?php if(isset($_GET['add_type']) && $_GET['add_type'] == 'in-house' && auth()->user()->role->type != 'seller'): ?>
                                    ...
                                    <div class="col-lg-6 selling_price_div">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field selling_price" name="selling_price" id="selling_price" placeholder="<?php echo e(__('product.selling_price')); ?>" type="number" min="1" step="<?php echo e(step_decimal()); ?>" value="<?php echo e(old('selling_price')?old('selling_price'):''); ?>">
                                        ...
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="tax_id" id="tax_id">
                                                ...
                                                <?php $__currentLoopData = $gst_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($gst->id); ?>" <?php if(old('tax_id') && old('tax_id') == $gst->id): ?> selected <?php endif; ?>><?php echo e($gst->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tab-content">
                                            <?php $__currentLoopData = $LanguageList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div role="tabpanel" class="tab-pane fade pelement <?php if(auth()->user()->lang_code == $language->code): ?> show active <?php endif; ?>" id="pelement<?php echo e($language->code); ?>">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            <textarea class="summernote2" id="specification" name="specification[<?php echo e($language->code); ?>]"> <?php echo e(old('specification.'.$language->code)); ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field" id="meta_title" name="meta_title[<?php echo e($language->code); ?>]" placeholder="<?php echo e(__('common.meta_title')); ?>" type="text" value="<?php echo e(old('meta_title.'.$language->code)); ?>">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <textarea class="primary_textarea height_112 meta_description" id="meta_description" placeholder="<?php echo e(__('common.meta_description')); ?>" name="meta_description[<?php echo e($language->code); ?>]" spellcheck="false"><?php echo e(old('meta_description.'.$language->code)); ?></textarea>
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="meta_title"> <?php echo e(__('common.meta_title')); ?></label>
                                            <input class="primary_input_field" id="meta_title" name="meta_title" placeholder="<?php echo e(__('common.meta_title')); ?>" type="text" value="<?php echo e(old('meta_title')); ?>">
                                            <span class="text-danger"><?php echo e($errors->first('meta_title')); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input mb-25">
                                            ...
                                            <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false" data-type="image" data-name="meta_image">
                                                ...
                                                <button class="" type="button">
                                                    ...
                                                    <input type="hidden" class="selected_files" value="<?php echo e(old('meta_image')); ?>">
                                                </button>
                                            </div>
                                        ...
                                        <div class="primary_input mb-25">
                                            <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="true" data-type="image" data-name="images[]">
                                                ...
                                                <button class="" type="button">
                                                    ...
                                                    <input type="hidden" class="selected_files image_selected_files" value="<?php echo e(old('images')?implode(',',old('images')):''); ?>">
                                                </button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-25">
                                            ...
                                            <span class="text-danger"><?php echo e($errors->first('pdf_file')); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                            ...
                                            <ul id="theme_nav" class="permission_list sms_list ">
                                                ...
                                                <li>
                                                    <label data-id="status_draft" class="primary_checkbox d-flex mr-12">
                                                        <input name="status" value="3" id="status_draft" <?php if(old('status') != null && old('status') == 3): ?> checked <?php endif; ?> class="de_active" type="radio">
                                                        <span class="checkmark"></span>
                                                    </label>
                ...
                <div class="col-12 text-center">
                    <?php if(auth()->user()->role->type != 'seller'): ?>
                        ...
                        <?php if(!isModuleActive('MultiVendor') ): ?>
                           <button class="primary_btn_2 mt-5 text-center saveBtn" data-value="save_publish"><i class="ti-check"></i><?php echo e(__('common.save')); ?> & <?php echo e(__('common.publish')); ?></button>
                        <?php endif; ?>

                        <?php if(isset($_GET['add_type']) && $_GET['add_type'] == 'in-house'): ?>
                           <button class="primary_btn_2 mt-5 text-center saveBtn" data-value="save_publish"><i class="ti-check"></i><?php echo e(__('common.save')); ?> & <?php echo e(__('common.publish')); ?></button>
                        <?php endif; ?>
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mytestdhatri/Modules/Product/Resources/views/products/create.blade.php ENDPATH**/ ?>