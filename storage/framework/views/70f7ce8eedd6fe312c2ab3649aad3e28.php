        ...
        (function($){
            ...
            $(document).ready(function(){
                $(document).on('submit', '#item_delete_form', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.flash-deals.delete')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on('change', '.changeStatus', function(event){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.flash-deals.status')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
                ...
                $(document).on('change', '.changeFeatured', function(event){
                    ...
                    $.ajax({
                        url: "<?php echo e(route('marketing.flash-deals.featured')); ?>",
                        type: "POST",
                        cache: false,
                        contentType: false,
                        processData: false,
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/mytestdhatri/Modules/Marketing/Resources/views/flash_deals/components/_scripts.blade.php ENDPATH**/ ?>