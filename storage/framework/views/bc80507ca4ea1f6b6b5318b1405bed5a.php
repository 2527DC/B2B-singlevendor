...
<div class="dashboard_white_box style2 bg-white mb_25">
    <div class="d-flex align-items-center gap_20 mb_30 flex-wrap">
        <h5 class="font_14 f_w_400 flex-fill mb-0"><?php echo e(__('defaultTheme.showing')); ?> <?php if($show_start == $show_end): ?> <?php echo e(getNumberTranslate($show_end)); ?> <?php else: ?> <?php echo e(getNumberTranslate($show_start)); ?> - <?php echo e(getNumberTranslate($show_end)); ?> <?php endif; ?> <?php echo e(__('common.of')); ?> <?php echo e(getNumberTranslate($total_number_of_items)); ?> <?php echo e(__('common.results')); ?></h5>
        <div class="wish_selects d-flex align-items-center gap_10 flex-wrap">
            <select class="amaz_select4" name="paginate_by" id="paginate_by">
                <option value="8" <?php if(isset($paginate) && $paginate == "8"): ?> selected <?php endif; ?>><?php echo e(__('common.show')); ?> <?php echo e(getNumberTranslate(8)); ?> <?php echo e(__('common.item’s')); ?></option>
                ...
                <option value="24" <?php if(isset($paginate) && $paginate == "24"): ?> selected <?php endif; ?>><?php echo e(__('common.show')); ?> <?php echo e(getNumberTranslate(24)); ?> <?php echo e(__('common.item’s')); ?></option>
                <option value="32" <?php if(isset($paginate) && $paginate == "32"): ?> selected <?php endif; ?>><?php echo e(__('common.show')); ?> <?php echo e(getNumberTranslate(32)); ?> <?php echo e(__('common.item’s')); ?></option>
            </select>
            <select name="sort_by" class="amaz_select4" id="product_short_list">
                ...
                <option value="low_to_high" <?php if(isset($sort_by) && $sort_by == "low_to_high"): ?> selected <?php endif; ?>><?php echo e(__('common.price')); ?> (<?php echo e(__('amazy.Low to high')); ?>)</option>
                <option value="high_to_low" <?php if(isset($sort_by) && $sort_by == "high_to_low"): ?> selected <?php endif; ?>><?php echo e(__('common.price')); ?> (<?php echo e(__('amazy.High to low')); ?>)</option>
            </select>
        </div>
    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="product_widget5 mb_30 style5">
                                ...
                                <div class="product_thumb_upper">
                                    ...
                                    ?>
                                    <a href="<?php echo e(singleProductURL(@$product->product->seller->slug ?? 't', @$product->product->slug)); ?>" class="thumb">
                                        <?php if(app('general_setting')->lazyload == 1): ?>
                                        <img data-src="<?php echo e($thumbnail); ?>" src="<?php echo e(showImage(themeDefaultImg())); ?>" alt="<?php echo e(@$product->product->product_name); ?>" title="<?php echo e(@$product->product->product_name); ?>" class="lazyload">
                                        <?php else: ?>
                                        <img src="<?php echo e($thumbnail); ?>" alt="<?php echo e(@$product->product->product_name); ?>" title="<?php echo e(@$product->product->product_name); ?>"  >

                                        <?php endif; ?>
                                    </a>
                                    <div class="product_action">
                                        <a class="addToCompareFromThumnail" data-producttype="<?php echo e(@$product->product->product->product_type); ?>"
                                            data-seller=<?php echo e(@$product->product->user_id); ?> data-product-sku=<?php echo e(@$product->product->skus->first()->id); ?> data-product-id=<?php echo e(@$product->product->id); ?>>
                                            <i class="ti-control-shuffle" title="<?php echo e(__('defaultTheme.compare')); ?>"></i>
                                        </a>
                                        <a class="quickView" data-product_id="<?php echo e($product->seller_product_id); ?>" data-type="product">
                                            <i class="ti-eye" title="<?php echo e(__('defaultTheme.quick_view')); ?>"></i>
                                        </a>
                                        <a class="removeWishlist" data-id="<?php echo e($product->id); ?>">
...
<?php endif; ?>
                                ...
                                <div class="product__meta text-center">
                                    ...
                                    <a href="<?php echo e(singleProductURL(@$product->product->seller->slug, @$product->product->slug)); ?>">
                                        <h4>
                                            <?php if(@$product->product->product_name): ?> <?php echo e(textLimit(@$product->product->product_name,56)); ?> <?php else: ?> <?php echo e(textLimit(@$product->product->product->product_name,56)); ?> <?php endif; ?>
                                        </h4>
                                    </a>

                                    <div class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                        <a class="amaz_primary_btn addToCartFromThumnail" data-producttype="<?php echo e(@$product->product->product->product_type); ?>" data-seller=<?php echo e($product->product->user_id); ?> data-product-sku=<?php echo e(@$product->product->skus->first()->id); ?>

                                            <?php if(@$product->product->hasDeal): ?>
                                                data-base-price=<?php echo e(selling_price(@$product->product->skus->first()->sell_price,@$product->product->hasDeal->discount_type,@$product->product->hasDeal->discount)); ?>

                                            <?php else: ?>
                                                <?php if(@$product->product->hasDiscount == 'yes'): ?>
                                                    data-base-price=<?php echo e(selling_price(@$product->product->skus->first()->sell_price,@$product->product->discount_type,@$product->product->discount)); ?>

                                                <?php else: ?>
                                                    data-base-price=<?php echo e(@$product->product->skus->first()->sell_price); ?>
                                        ...
                                        <p>
                                            <span>
                                                ...
                                                <del>
                                                    <?php echo e(getProductwitoutDiscountPrice(@$product->product)); ?>

                                                </del>
                                                <?php endif; ?>
                                            </span>
                                            <strong>
                                                <?php echo e(getProductDiscountedPrice(@$product->product)); ?>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="product_widget5 mb_30 style5">
                                ...
                                ?>
                                <div class="product_thumb_upper">
                                    <a href="<?php echo e($prod_url); ?>" class="thumb">
                                        <img src="<?php echo e($thumbnail); ?>" alt="<?php echo e(textLimit(@$product->giftcard->name,28)); ?>" title="<?php echo e(textLimit(@$product->giftcard->name,28)); ?>">
                                    </a>
                                    <div class="product_action">
                                ...
                                <div class="product__meta text-center">
                                    <a href="<?php echo e($prod_url); ?>">
                                        <h4><?php echo e(textLimit(@$product->giftcard->name,28)); ?></h4>
                                    </a>
                                    <?php
...
<?php endif; ?>
                                    ...
                                    <div class="product_prise">
                                        <p><?php echo e($price_qty); ?></p>
                                        <a class="add_cart add_to_cart add_to_cart_gift_thumnail" data-prod_info = "<?php echo e(json_encode($showData)); ?>" data-gift-card-id="<?php echo e(@$product->giftcard->id); ?>" data-seller="<?php echo e(App\Models\User::where('role_id', 1)->first()->id); ?>" data-base-price="<?php if(@$product->giftcard->hasDiscount()): ?> <?php echo e(selling_price(@$product->giftcard->sell_price, @$product->giftcard->discount_type, @$product->giftcard->discount)); ?> <?php else: ?> <?php echo e(@$product->giftcard->sell_price); ?> <?php endif; ?>"  href="#"><?php echo e(__('common.add_to_cart')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /var/www/html/Production_dev/resources/views/frontend/amazy/pages/profile/partials/_wishlist_with_paginate.blade.php ENDPATH**/ ?>