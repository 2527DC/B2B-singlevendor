        	...
        	"use strict";
             var baseUrl = $('#app_base_url').val();
                $(document).ready(function () {
                    ...
                    stateSave: true,
                    "ajax": ( {
                        url: "<?php echo e(route('tags.get_data')); ?>"
                    }),
                    ...
                    function tagList() {
                        $.ajax({
                            url: "<?php echo e(route("tags.get_list")); ?>",
                            type: "GET",
                            dataType: "HTML",
                            success: function (response) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/DhatriProduction/Modules/Setup/Resources/views/tags/scripts.blade.php ENDPATH**/ ?>