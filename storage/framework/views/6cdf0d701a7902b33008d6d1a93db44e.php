        ...
        <div class="customer-profile bg-white p-3 rounded-3">
            <div class="customer-info d-flex align-items-center flex-wrap mb-3 rounded-3">
                <div class="customer-info-img">
                    <img id="customerMiniImage" src="<?php echo e(auth()->user()->avatar?showImage(auth()->user()->avatar):showImage('frontend/default/img/avatar.jpg')); ?>" alt="<?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>" title="<?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>">                </div>
                <div class="customer-info-content d-flex align-items-center flex-wrap">
                    <div>
                        <p class="text-white"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></p>
                        <?php if(auth()->user()->email): ?>
                            <span class="email_text font_14 f_w_400 mute_text position-relative text-white"><?php echo e(auth()->user()->email); ?> </span><br/>
                        <?php endif; ?>
                        <?php if(auth()->user()->phone): ?>
                            <span  class="number_text font_14 f_w_400 mute_text text-white"><?php echo e(auth()->user()->phone); ?></span>
                        <?php endif; ?>

                    </div>
                    <a href="<?php echo e(url('/profile')); ?>" class="amaz_primary_btn d-inline-flex align-items-center gap-2 ms-auto"><?php echo e(__('common.edit')); ?></a>
                </div>
            </div>
            <?php if(auth()->user()->role->type == 'customer' && isModuleActive('MultiVendor')): ?>
                <a href="<?php echo e(route('frontend.merchant-register-step-first')); ?>" target="_blank" class="amaz_primary_btn bg-gray d-block text-center mb-4"><?php echo e(__('common.convert_as_seller')); ?></a>
            <?php endif; ?>

            <?php if(isModuleActive('Affiliate')): ?>
                <?php if(empty(auth()->user()->affiliate_request) ): ?>
                  <a href="<?php echo e(route('affiliate.customerJoinAffiliate')); ?>"  class="amaz_primary_btn bg-gray d-block text-center mb-4"><?php echo e(__('common.join_affiliate')); ?></a>
                <?php endif; ?>

                <?php if(auth()->user()->affiliate_request == 1): ?>
                    <?php if(auth()->user()->accept_affiliate_request == 0): ?>
                        <a href="javascript:void(0)" target="_blank" class="amaz_primary_btn bg-gray d-block text-center mb-4"><?php echo e(__('common.join_affiliate')); ?></a>
                    <?php elseif(auth()->user()->accept_affiliate_request == 1): ?>
                        <a href="<?php echo e(route('affiliate.my_affiliate.index')); ?>" target="_blank" class="amaz_primary_btn bg-gray d-block text-center mb-4"><?php echo e(__('common.affiliate_profile')); ?></a>
                    <?php endif; ?>
                <?php endif; ?>
            <?php endif; ?>
            ...
            <div class="customer-blance d-flex align-items-end justify-content-between rounded-3 flex-wrap gap-2 border-1">
                <div  class="flex-grow-1">
                    <div class="w-100 text-center">
                        <span><?php echo e(__('common.total_balance')); ?></span>
                        <p class="fw-bold" id="total_balance"><?php echo e(auth()->check()?single_price(auth()->user()->CustomerCurrentWalletAmounts):single_price(0.00)); ?></p>
                    </div>
                </div>
                ...
                <div class="flex-grow-1">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#recharge_wallet"  class="amaz_primary_btn d-inline-flex align-items-center gap-1 ms-auto w-100 justify-content-center">
                        ...
                        <span class="text-capitalize"><?php echo e(__('wallet.recharge_wallet')); ?></span>
                    </a>
                </div>
                <?php endif; ?>
            </div>
            <?php if(auth()->user()->LastRehcarge): ?>
                <div class="customer-transaction">
                    <div class="head d-flex align-items-center justify-content-between mb-3">
                        <p><?php echo e(__('wallet.last_transaction')); ?></p>
                        <a href="<?php echo e(route('my-wallet.index', 'customer')); ?>"><?php echo e(__('common.view_all')); ?></a>
                    </div>
                    <div class="customer-transaction-card">
                        <?php $__currentLoopData = auth()->user()->LastRehcarge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lastrehcarge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex align-items-center justify-content-between list">
                            <p><?php echo e(dateConvert($lastrehcarge->created_at)); ?></p>
                                <?php
    ...
    <div class="card border-0 rounded-3">
        <div class="dashboard_sidebar_menuList p-3 rounded-3">
            <ul>
                ...
                <li>
                    <a class="position-relative d-flex align-items-center <?php echo e(request()->is('support-ticket/*') ?'active' : ''); ?>" href="<?php echo e(route('clubpoint.frontend.earning-points')); ?>">
                    ...
                    <?php echo e(__('common.earning_points')); ?></a>
                </li>
                <?php endif; ?>
                <li>
...
<?php /**PATH /var/www/html/Production_dev/resources/views/frontend/amazy/pages/profile/partials/_menu.blade.php ENDPATH**/ ?>