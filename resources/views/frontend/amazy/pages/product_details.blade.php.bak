                                ...
                                <div class="slider-for gallery_large">
                                    ...
                                    @else
                                        <div class="item-slick slick-current slick-active" id="thumb_{{$product->id}}">
                                            <img class="varintImg zoom_01" @if ($product->thum_img != null)
                                            data-zoom-image="{{showImage($product->thum_img)}}" @else
                                                    data-zoom-image="{{showImage($product->product->thumbnail_image_source)}}"
                                                @endif @if ($product->thum_img != null) src="{{showImage($product->thum_img)}}"
                                                @else src="{{showImage($product->product->thumbnail_image_source)}}" @endif
                                                alt="{{$product->product_name}}" title="{{$product->product_name}}">
                                        </div>
                                    @endif
                                </div>
                                    ...
                                    @if(count($product->product->gallary_images) > 0)
                                        @foreach($product->product->gallary_images as $i => $image)
                                            <div class="item-slick {{$i == 0 ? 'slick-active slick-current' : ''}}">
                                                <img src="{{showImage($image->images_source)}}" alt="{{$product->product_name}}"
                                                    title="{{$product->product_name}}">
                                            </div>
                                        @endforeach
                                    @else
                                        <div class="item-slick slick-active slick-current">
                                            <img @if ($product->thum_img != null) src="{{showImage($product->thum_img)}}" @else
                                            src="{{showImage($product->product->thumbnail_image_source)}}" @endif
                                                alt="{{$product->product_name}}" title="{{$product->product_name}}">
                                        </div>
                                    @endif
                                </div>
                        ...
                        <div class="col-lg-6 col-xl-6">
                            <div class="product_content_details mb_20">
                                ...
                                <div class="viendor_text d-flex align-items-center">
                                    <p class="stock_text"> <span class="text-uppercase">{{__('defaultTheme.sku')}}:</span>
                                        <span class="stock_value" id="sku_id_li">
                                            {{@$product->skus->where('status', 1)->first()->sku->sku ?? '-'}}</span>
                                    </p>
                                ...
                                @if(isModuleActive('MultiVendor'))
                                    @php
                                        ...
                                        if ($product->seller->role->type == 'seller') {
                                            $sellerName = @$product->seller->SellerAccount->seller_shop_display_name
                                                ?: ($product->seller->first_name . ' ' . $product->seller->last_name);
                                        } else {
                                            $sellerName = app('general_setting')->company_name;
                                        }
                                    @endphp
                                    <div class="viendor_text d-flex align-items-center">
                                        <p class="stock_text">
                                            <span class="text-uppercase">warehouse:</span>
                                            <a id="shopLink_top" href="{{ $sellerUrl }}"
                                                style="font-weight:600;">{{ $sellerName }}</a>
                                        </p>
                                    </div>
                                @endif
                                <div class="viendor_text d-flex align-items-center">
                                    ...
                                    @foreach (session()->get('item_details') as $key => $item)
                                        @if ($item['attr_id'] === 1)
                                            <div class="product_color_varient mb_20">
                                                <h5 class="font_14 f_w_500 theme_text3  text-capitalize d-block mb_10" id="color_name">
                                                    ...
                                                    @foreach ($item['value'] as $k => $value_name)
                                                        <label class="round_checkbox d-flex">
                                                            <input id="radio-{{$k}}" name="color_filt"
                                                                class="attr_val_name  radio_{{ $item['id'][$k] }}" type="radio"
                                                                color="color" @if ($k === 0) checked @endif data-value="{{ $item['id'][$k] }}"
                                                                data-name="{{ $item['name'] }}" data-value-key="{{$item['attr_id']}}"
                                                                value="{{ $value_name }}" />
                                        ...
                                        @if ($item['attr_id'] != 1)
                                            <div class="product_color_varient mb_20">
                                                <h5 class="font_14 f_w_500 theme_text3  text-capitalize d-block mb_10"
                                                    id="size_name{{$key}}">{{$item['name']}}: {{$item['value'][0]}}</h5>
                                                <div class="color_List d-flex gap_5 flex-wrap">
                                                    <input type="hidden" class="attr_value_name" data-name="{{ $item['name'] }}"
                                ...
                                <div class="product_info">
                                    <div class="single_pro_varient">
                                        ...
                                        <div class="product_number_count mr_5" data-target="amount-1">
                                            ...
                                            <input name="qty" id="qty" class="count_single_item input-number qty"
                                                type="text" data-value="{{@$product->product->minimum_order_qty}}"
                                        ...
                                        <div class="product_details_sujjetion_box">
                                            <a href="{{singleProductURL(@$both_buy_product->seller->slug, $both_buy_product->slug)}}"
                                                ...
                                                <div class="product_details_sujjetion_content">
                                                    <h4 class="fs-6 f_w_700">@if ($both_buy_product->product_name)
                                                    {{ textLimit($both_buy_product->product_name, 28) }} @else
                                                        {{textLimit(@$both_buy_product->product->product_name, 28)}} @endif
                                                    </h4>
                                            ...
                                            <div class="product_details_sujjetion_total d-flex align-items-center gap_15">
                                                ...
                                                <a href="#" class="amaz_primary_btn style3 text-uppercase" id="both_buy_btn"
                            ...
                            <div class="product_details_dec mb_76">
                                ...
                                <div class="product_details_dec_body">
                                    <div class="single_desc style2 mb_20">
                                        <p class="f_w_500 m-0">{{ __('common.brand') }}: {{@$product->product->brand->name}}
                                        </p>
                                        ...
                                        <p class="f_w_500 m-0">{{ __('common.minimum_order_quantity') }}:
                                            {{getNumberTranslate(@$product->product->minimum_order_qty)}}
                                        </p>
                                        <p class="f_w_500 m-0">{{ __('common.maximum_order_quantity') }}:
                                            {{getNumberTranslate(@$product->product->max_order_qty)}}
                                        </p>
                                        <p class="f_w_500 m-0">{{ __('common.listed_date') }}:
                                            {{dateConvert(@$product->product->created_at)}}
                                        </p>
                                    </div>
                                    @php
                                            ...
                                            @if ($product->product->video_provider == 'daily_motion')
                                                ...
                                                <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;">
                                                    <iframe
                                                        ...
                                                        frameborder="0" type="text/html" src="{{$link}}" width="100%" height="100%"
                                            ...
                                            <div class="product_widget5 mb_30 style5 w-100">
                                                    ...
                                                    <a href="{{singleProductURL($recent_viewed_product->seller->slug, $recent_viewed_product->slug)}}"
                                                        ...
                                                        @if(app('general_setting')->lazyload == 1)
                                                            <img data-src="{{$thumbnail}}" src="{{showImage(themeDefaultImg())}}"
                                                                ...
                                                                title="{{@$recent_viewed_product->product_name}}" class="lazyload">
                                                        @else
                                                            <img src="{{$thumbnail}}" alt="{{@$recent_viewed_product->product_name}}"
                                                    ...
                                                    @if(isGuestAddtoCart())
                                                        <div class="product_action">
                                                            <a href="" class="addToCompareFromThumnail"
                                                                ...
                                                                data-seller={{ $recent_viewed_product->user_id }} data-product-sku={{ @$recent_viewed_product->skus->first()->id }} data-product-id={{ $recent_viewed_product->id }}>
                                                            ...
                                                            <a class="quickView" data-product_id="{{$recent_viewed_product->id}}"
                                                                data-type="product">
                                                ...
                                                <div class="product__meta text-center">
                                                    ...
                                                    <a
                                                        ...
                                                        <h4>@if ($recent_viewed_product->product_name)
                                                        {{ textLimit(@$recent_viewed_product->product_name, 50) }} @else
                                                    ...
                                                    @if(isModuleActive('MultiVendor'))
                                                        @php
                                                            $sellerUrl = $recent_viewed_product->seller->slug ? route('frontend.seller', $recent_viewed_product->seller->slug) : route('frontend.seller', base64_encode($recent_viewed_product->seller->id));
                                                            $sellerName = $recent_viewed_product->seller->role->type == 'seller' ? (@$recent_viewed_product->seller->SellerAccount->seller_shop_display_name ?: ($recent_viewed_product->seller->first_name . ' ' . $recent_viewed_product->seller->last_name)) : app('general_setting')->company_name;
                                                        @endphp
                                                    ...
                                                    @if(isGuestAddtoCart())
                                                        <div
                                                            ...
                                                            <a class="amaz_primary_btn addToCartFromThumnail"
                                                                data-producttype="{{ @$recent_viewed_product->product->product_type }}"
                                                                data-seller={{ $recent_viewed_product->user_id }} data-product-sku={{ @$recent_viewed_product->skus->first()->id }} @if (@$recent_viewed_product->hasDeal) data-base-price={{ selling_price(@$recent_viewed_product->skus->first()->sell_price, @$recent_viewed_product->hasDeal->discount_type, @$recent_viewed_product->hasDeal->discount) }} @else @if (@$recent_viewed_product->hasDiscount == 'yes') data-base-price={{ selling_price(@$recent_viewed_product->skus->first()->sell_price, @$recent_viewed_product->discount_type, @$recent_viewed_product->discount) }} @else data-base-price={{ @$recent_viewed_product->skus->first()->sell_price }} @endif @endif
                                                                data-shipping-method=0 data-product-id={{ $recent_viewed_product->id }}
                        ...
                        <div class="amazcart_delivery_wiz mb_20">
                            ...
                            <div class="amazcart_delivery_wiz_body">
                                ...
                                <p class="delivery_text font_14 f_w_400">{{__('common.free_shipping_on')}}
                                    ...
                                    {{single_price($free_shipping->minimum_shopping)}}
                                </p>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="amazcart_delivery_wiz_body">
                            <div class="loc_city_selectBox d-flex flex-column">
                                <div class="selectBox_box ">
                                    ...
                                    <select class="amaz_select2 mb_10 w-100" id="select_city" name="select_city">
                                        <option data-display="Choose City" selected disabled>{{__('common.choose_city')}}
                                        </option>
                                        @if($country)
                                ...
                                <div class="selectBox_box">
                                    ...
                                    <select class="amaz_select2 w-100" id="selectPickup">
                                        <option data-display="Choose pickup location" disabled>
                                            {{__('amazy.Choose pickup location')}}
                                        </option>
                                        @if($pickup_locations)
                                            @foreach($pickup_locations as $pickup_location)
                                                <option value="{{$pickup_location->id}}" {{$pickup_location->is_default ? 'selected' : ''}}>{{$pickup_location->address}}
                                                </option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 mb_10">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{url('/')}}/public/frontend/amazy/img/product_details/details_car.svg"
                            ...
                            <div class="amazcart_delivery_wiz_sep d-flex gap_15 ">
                                <div class="icon d-flex align-items-center justify-content-center ">
                                    <img src="{{url('/')}}/public/frontend/amazy/img/product_details/details_pickup.svg"
                                        alt="{{__('amazy.Pickup Location')}}" title="{{__('amazy.Pickup Location')}}">
                                </div>
                                <div class="amazcart_delivery_wiz_content">
                                ...
                                <div class="product_widget5 mb_30 style5 w-100">
                                    <div class="product_thumb_upper">
                                        ...
                                        <a href="{{singleProductURL(@$related_seller_product->seller->slug, $related_seller_product->slug)}}"
                                            ...
                                            @if(app('general_setting')->lazyload == 1)
                                                <img data-src="{{$thumbnail}}" src="{{ showImage(themeDefaultImg()) }}"
                                                    ...
                                                    title="{{@$related_seller_product->product_name}}" class="lazyload">
                                            @else
                                                <img src="{{$thumbnail}}" alt="{{@$related_seller_product->product_name}}"
                                        ...
                                        @if(isGuestAddtoCart())
                                            <div class="product_action">
                                                <a href="" class="addToCompareFromThumnail"
                                                    data-producttype="{{ @$related_seller_product->product->product_type }}" data-seller={{ $related_seller_product->user_id }} data-product-sku={{ @$related_seller_product->skus->first()->id }} data-product-id={{ $related_seller_product->id }}>
                                    ...
                                    <div class="product__meta text-center">
                                        ...
                                        <a
                                            ...
                                            <h4>@if ($related_seller_product->product_name)
                                            {{ textLimit(@$related_seller_product->product_name, 50) }} @else
                                                {{ textLimit(@$related_seller_product->product->product_name, 50) }} @endif
                                            </h4>
                                        </a>
                                        @if(isModuleActive('MultiVendor'))
                                            @php
                                                $sellerUrl = $related_seller_product->seller->slug ? route('frontend.seller', $related_seller_product->seller->slug) : route('frontend.seller', base64_encode($related_seller_product->seller->id));
                                                $sellerName = $related_seller_product->seller->role->type == 'seller' ? (@$related_seller_product->seller->SellerAccount->seller_shop_display_name ?: ($related_seller_product->seller->first_name . ' ' . $related_seller_product->seller->last_name)) : app('general_setting')->company_name;
                                            @endphp
                                            <p class="stock_text mb-1"><small>Warehouse: <a href="{{ $sellerUrl }}" style="font-weight:600;">{{ $sellerName }}</a></small></p>
                                        @endif
                                        ...
                                        @if(isGuestAddtoCart())
                                            <div class="product_price d-flex align-items-center justify-content-between flex-wrap">
                                                <a class="amaz_primary_btn add_cart add_to_cart addToCartFromThumnail"
                                                    data-producttype="{{ @$related_seller_product->product->product_type }}" data-seller={{ $related_seller_product->user_id }} data-product-sku={{ @$related_seller_product->skus->first()->id }} @if(@$related_seller_product->hasDeal)
                                                    data-base-price={{ selling_price(@$related_seller_product->skus->first()->sell_price, @$related_seller_product->hasDeal->discount_type, @$related_seller_product->hasDeal->discount) }} @else
                                                        @if(@$related_seller_product->hasDiscount == 'yes') data-base-price={{ selling_price(@$related_seller_product->skus->first()->sell_price, @$related_seller_product->discount_type, @$related_seller_product->discount) }} @else
                                                    data-base-price={{ @$related_seller_product->skus->first()->sell_price }} @endif @endif
                                                    data-shipping-method=0 data-product-id={{ $related_seller_product->id }}
                                                    ...
                                                    data-prod_info="{{ json_encode($showData) }}"><svg width="16" height="16"
