                    ...
                    <div class="payment_modal_wallet">
                        ...
                        <div class="wallet_payent_box">
                            ...
                            @if (@$payment_gateways->where('method','RazorPay')->first()->active_status == 1)
                                <form action="{{ route('my-wallet.store') }}" method="POST" id="razorpay_form">
                                    <input type="hidden" name="method" value="RazorPay">
                                    <input type="hidden" name="amount" value="{{ $recharge_amount * 100 }}">
                                    <input type="hidden" name="razorpay_payment_id" id="razorpay_payment_id" value="">
                                    @csrf

                                    <button class="wallet_elemnt" type="button" id="razorpay_btn_wallet">
                                    ...
                                    @php
                                        ...
                                        $razor_key = @$razor_credential->perameter_1 ?: config('services.razorpay.key');
                                    @endphp
                                </form>
                                ...
                                <script>
                                    (function($) {
                                        ...
                                        $(document).ready(function() {
                                            $(document).on('click', '#razorpay_btn_wallet', function(e){
                                                e.preventDefault();
