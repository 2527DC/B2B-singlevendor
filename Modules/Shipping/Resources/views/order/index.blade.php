...
@section('mainContent')
    <section class="admin-visitor-area up_st_admin_visitor">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="QA_section QA_section_heading_custom check_box_table mt-80">
                        {{-- Import Invoice button removed --}}
                        @if (permissionCheck('shipping.invoice_generate'))
                            <form id="bulk_invoice_download_form" method="POST" action="{{ route('shipping.bulk_invoice_download') }}" target="_blank" style="display:inline-block;">
                                @csrf
                                            ...
                                            <td>
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                                        ...
                                                        @endif
                                                        @if (permissionCheck('shipping.method_update') && $row->carrier_order_id == null && ($row->length && $row->breadth && $row->height && $row->weight))
        ...
        {{-- bulk invoice import URL removed --}}
