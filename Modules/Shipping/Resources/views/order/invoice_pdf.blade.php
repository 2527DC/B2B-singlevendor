        ...
        <tr>
            ...
            <td class="header-right">
                <table class="metadata" style="width:100%; text-align:right;">
                    <tr><td width="60%">Inv. No.</td><td width="40%">{{ $invoice_number }}</td></tr>
            ...
            <td class="address-box">
                ...
                @php
                    if ($order->order->customer_id) {
                        // CustomerAddress uses getCity/getState
                        ...
                        // GuestOrderDetail uses getShippingCity/getShippingState
            ...
            <td class="address-box">
                ...
                @php
                    if ($order->order->customer_id) {
                        ...
                        // GuestOrderDetail uses getBillingCity/getBillingState
