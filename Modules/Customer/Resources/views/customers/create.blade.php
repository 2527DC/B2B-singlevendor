                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input name="store_name" class="primary_input_field" placeholder="Store Name"
                                            type="text" value="{{ old('store_name') }}" required>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input type="file" name="store_image" class="primary_input_field file_input_fix"
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input type="file" name="document" class="primary_input_field file_input_fix"
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="">{{ __('common.confirm_password') }}<span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label"
                                            for="">{{__('common.referral_code_(optional)')}}</label>
                                ...
                                <div class="col-xl-4">
                                                <div class="primary_input mb-25">
                                                    <label class="primary_input_label" for="warehouse_id">Select Warehouse <span class="text-danger">*</span></label>
                                                    <select name="warehouse_id" id="warehouse_id" class="primary_select mb-25" required>
                                                        <option value="" disabled selected>-- Select Warehouse --</option>
                                                        @foreach($warehouses as $wh)
                                                            <option value="{{ $wh->user_id }}" {{ old('warehouse_id') == $wh->user_id ? 'selected' : '' }}>
                                    ...
                                    <div class="d-flex justify-content-center pt_20">
                                        <button type="submit" class="primary-btn semi_large2 fix-gr-bg"
                                            id="save_button_parent"><i
                                                class="ti-check"></i>{{ __('common.create') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
