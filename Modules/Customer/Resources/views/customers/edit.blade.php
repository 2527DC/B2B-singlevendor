                    ...
                    <div class="white_box_50px box_shadow_white">
                        <form action="{{ route('admin.customer.update', $customer->id) }}" method="POST" id="staff_addForm"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="">{{ __('common.email_or_phone') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input name="store_name" class="primary_input_field" placeholder="Store Name"
                                            type="text"
                                            value="{{ old('store_name') ? old('store_name') : $customer->store_name }}"
                                            required>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input name="gst_number" id="gst_number" class="primary_input_field"
                                            ...
                                            value="{{ old('gst_number', $customer->gst_number ?? 'NA') }}">
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input type="file" name="store_image" class="primary_input_field"
                                            accept=".jpg,.jpeg,.png">
                                        <span class="text-danger">{{ $errors->first('store_image') }}</span>
                                        @if($customer->store_image)
                                            <div class="mt-2">
                                                <img src="{{ asset($customer->store_image) }}" alt="Store Image"
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input type="file" name="document" class="primary_input_field"
                                            accept=".jpg,.jpeg,.png,.pdf">
                                        <span class="text-danger">{{ $errors->first('document') }}</span>
                                        @if($customer->document)
                                            <div class="mt-2">
                                                <a href="{{ asset($customer->document) }}" target="_blank">View Current
                                                    Document</a>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        ...
                                        <input name="password" class="primary_input_field name"
                                            placeholder="{{ __('common.password') }}" value="{{old('password')}}"
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label"
                                            for="">{{ __('common.confirm_password') }}</label>
                                ...
                                <div class="col-xl-4">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="warehouse_id">Select Warehouse <span
                                                class="text-danger">*</span></label>
                                        ...
                                        <ul id="theme_nav" class="permission_list sms_list ">
                                            <li>
                                                <label data-id="bg_option"
                                                    class="primary_checkbox d-flex mr-12 extra_width">
                                                    <input name="status" id="status_active" value="1"
                                                        {{$customer->is_active == 1 ? 'checked' : ''}} class="active"
                                                        type="radio">
                                            ...
                                            <li>
                                                <label data-id="color_option"
                                                    ...
                                                    <input name="status" value="0" id="status_inactive" class="de_active"
                                                        type="radio" {{$customer->is_active == 0 ? 'checked' : ''}}>
                                                    <span class="checkmark"></span>
                                                </label>
