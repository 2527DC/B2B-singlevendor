                    ...
                    <div class="box_header_right">
                        <div class="float-lg-right float-none pos_tab_btn justify-content-end">
                            <ul class="nav" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active show" href="#all_customer" role="tab" data-toggle="tab" id="1"
                                        aria-selected="true">{{ __('common.all') }} {{__('common.customer')}}</a>
                                </li>
                                ...
                                @if (permissionCheck('admin.customer.create'))
                                    <li class="nav-item">
                                        <a class="nav-link active"
                                            href="{{route('admin.customer.create')}}">{{ __('common.create') }}
                                            {{__('common.customer')}}</a>
                                    </li>
                                @endif
                            </ul>
                        </div>
