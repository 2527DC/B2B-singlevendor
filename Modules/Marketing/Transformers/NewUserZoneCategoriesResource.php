                    ...
                    foreach ($prntCat->AllProducts as $prntCatAllPdct) {
                        ...
                        if (isset($prntCatAllPdct->product)) {
                            ...
                            $prntCatAllPdctPdct = [
                                ...
                                "unit_type_id" => ($prntCatPdctsPdct->unit_type && $prntCatPdctsPdct->unit_type->id) ? $prntCatPdctsPdct->unit_type->name : $prntCatPdctsPdct->unit_type_id,
                        ...
                        foreach ($subCat->AllProducts as $subCatAllPdct) {
                            ...
                            if (isset($subCatAllPdct->product)) {
                                ...
                                $subCatAllPdctPdct = [
                                    ...
                                    "unit_type_id" => ($subCatPdctsPdct->unit_type && $subCatPdctsPdct->unit_type->id) ? $subCatPdctsPdct->unit_type->name : $subCatPdctsPdct->unit_type_id,
