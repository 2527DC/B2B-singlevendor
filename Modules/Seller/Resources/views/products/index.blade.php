...
@section('mainContent')
                            ...
                            <ul class="nav nav_list" role="tablist">
                                @if (permissionCheck('seller.product.index') || auth()->user()->role->type == "seller")
                                    <li class="nav-item" id="product_list_li">
                                        <a class="nav-link active show" href="#product_list" role="tab" data-toggle="tab" id="1"
                                ...
                                @if (permissionCheck('seller_out_of_stock_product'))
                                    <li class="nav-item" id="stock_out_product_list_li">
                                        <a class="nav-link" href="#out_of_stock_product_list" role="tab" data-toggle="tab"
                                            id="1" aria-selected="true">{{ __('product.out_of_stock_list') }}</a>
                                    </li>
                                @endif
                                @if (permissionCheck('seller_disabled_product'))
                                    <li class="nav-item" id="disabled_product_list_li">
                                        <a class="nav-link" href="#disabled_product_list" role="tab" data-toggle="tab" id="1"
                                ...
                                @if (auth()->user()->role->type == "seller")
                                    @if (permissionCheck('seller.product.create'))
                                        <li class="nav-item">
                                            <a class="primary-btn radius_30px mr-10 fix-gr-bg add_new_product"
                                                href="{{ route('seller.product.create') }}"><i
                                                    class="ti-plus"></i>{{ __('product.add_new_product') }}</a>
                                        </li>
                                    @endif
                                @else
                                    @if (permissionCheck('admin.my-product.create'))
                                        <li class="nav-item">
                                            <a class="primary-btn radius_30px mr-10 fix-gr-bg add_new_product"
                                                href="{{ route('admin.my-product.create') }}"><i
                                                    class="ti-plus"></i>{{ __('product.add_new_product') }}</a>
                                        </li>
                                    @endif
                                @endif
                        ...
                        <div class="tab-content" id="product_tab_content">
                            ...
                            {{-- @if (permissionCheck('seller_own_product') && auth()->user()->role->type != 'superadmin')
                                <div role="tabpanel" class="tab-pane fade" id="my_product_data">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('product.my_product_list') }}
                                            </h3>
                                        </div>
                                    </div>
                            ...
                            @if (permissionCheck('seller_out_of_stock_product'))
                                <div role="tabpanel" class="tab-pane fade" id="out_of_stock_product_list">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('product.out_of_stock_list') }}
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="QA_section3 QA_section_heading_custom th_padding_l0">
                                    ...
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">
                                                {{ __('product.disabled_product_list') }}
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="QA_section3 QA_section_heading_custom th_padding_l0">
    ...
    @include('backEnd.partials._deleteModalForAjax', [
        'item_name' => __('common.product '),
        'form_id' =>
            'product_delete_form',
        'modal_id' => 'product_delete_modal',
        'delete_item_id' => 'product_delete_id'
    ])
