            ...
            <div class="col-12">
                <div class="box_header">
                    <div class="main-title d-flex justify-content-between w-100">
                        <h3 class="mb-0 mr-30">{{__('common.add_new')}} {{__('common.warehouse')}}</h3>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="white_box_50px box_shadow_white">
                    <form action="{{ $is_admin ? route('admin.warehouses.store') : route('seller.warehouses.store') }}" method="POST" id="warehouse_addForm">
                        @csrf
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="col-md-12">
                                    <div class="primary_input mb-25">
                                        ...
                                        <select name="user_id" id="user_id" class="primary_select mb-15" required>
                                            <option value="" disabled selected>{{__('common.select')}} {{__('common.owner')}}</option>
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}" {{ old('user_id') == $user->id ? 'selected' : '' }}>{{ $user->first_name }} ({{ $user->role->name }}) - {{ $user->email }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" class="primary_input_field" placeholder="{{ __('common.name') }}" name="warehouse_name" value="{{old('warehouse_name')}}" required>
                            ...
                            <div class="col-md-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" class="primary_input_field" placeholder="{{ __('common.phone') }}" name="warehouse_phone" value="{{old('warehouse_phone')}}" required>
                            ...
                            <div class="col-md-12">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" class="primary_input_field" placeholder="{{ __('common.address') }}" name="warehouse_address" value="{{old('warehouse_address')}}" required>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <select name="warehouse_country" id="warehouse_country" class="primary_select mb-15" required>
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{ $country->id }}" {{ old('warehouse_country') == $country->id ? 'selected' : '' }}>{{ $country->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="primary_input mb-25">
                                    ...
                                    <input type="text" class="primary_input_field" placeholder="{{ __('common.postcode') }}" name="warehouse_postcode" value="{{old('warehouse_postcode')}}" required>
                            ...
                            <div class="col-md-12 text-center">
                                <div class="d-flex justify-content-center pt_20">
                                    <button type="submit" class="primary-btn semi_large2 fix-gr-bg" id="save_button"><i class="ti-check"></i>{{ __('common.save') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
