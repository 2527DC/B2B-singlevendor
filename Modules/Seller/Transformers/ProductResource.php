    ...
    public function toArray($request)
    {
        ...
        if (isset($this->product)) {
                        ...
                        foreach ($category->AllProducts as $product) {
                            ...
                            if (isset($product->product)) {
                                ...
                                $prodct = [
                                    ...
                                    "unit_type_id" => ($prdt->unit_type && $prdt->unit_type->id) ? $prdt->unit_type->name : $prdt->unit_type_id,
            ...
            $product = [
                ...
                "unit_type_id" => ($goods->unit_type && $goods->unit_type->id) ? $goods->unit_type->name : $goods->unit_type_id,
